...
/**
 * YAML descriptor for Enonic XP Form Fragments.
 * https://developer.enonic.com/docs/cms/stable/schemas/form-fragments
 */
export interface HttpsJsonSchemastoreOrgEnonicXpFormFragment800B4Json {
  kind: 'FormFragment';
