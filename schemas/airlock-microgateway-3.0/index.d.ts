...
export interface Mapping {
  access_token?: {
    ...
    extraction?: {
       ...
       */
      mode?: ('header' | 'parameter' | 'cookie') | null;
      /**
  ...
  api_security?: {
    ...
    openapi?: {
       ...
       */
      path_matching?: ('client_view' | 'backend_view') | null;
      /**
  ...
  auth?: {
     ...
     */
    flow?: ('redirect' | 'deny_access' | 'one_shot' | 'one_shot_with_body' | 'ntlm') | null;
    /**
   ...
   */
  operational_mode?: ('production' | 'integration') | null;
  request?: {
    /**
    ...
    default_actions?: Action[] | null;
  } | null;
  response?: {
    /**
     * A list of request custom actions executed in order of appearance. Only one action type (e.g. add_header or header_redirect) can be specified in each entry. Create multiple list positions if needed.
     */
    custom_actions?: CustomAction1[] | null;
    default_actions?: Action[] | null;
    /**
     * Replacement rules for error responses returned by backend systems.
     */
    error_page_replacements?: PageReplacement[] | null;
    rewrites?: {
      /**
   ...
   */
  session_handling?: ('enforce_session' | 'optional_session' | 'optional_session_no_refresh' | 'ignore_session') | null;
  /**
   * Allowed values are: block, terminate_session, notify.
   */
  threat_handling?: ('terminate_session' | 'block' | 'notify') | null;
  timeouts?: {
    /**
...
export interface RuleGroup {
   ...
   */
  level?: ('basic' | 'standard' | 'strict') | null;
  /**
