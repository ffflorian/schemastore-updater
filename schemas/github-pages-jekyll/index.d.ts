...
/**
 * A Jekyll _config.yml file for sites built by GitHub Pages.
 */
export type GitHubPagesJekyllConfigSchema = JekyllConfigSchema & {
  source?: never;
  destination?: never;
  /**
   * GitHub Pages sets incremental builds to false.
   */
  incremental?: false;
  /**
   * GitHub Pages sets LSI to false.
   */
  lsi?: false;
  /**
   * GitHub Pages always runs Jekyll in safe mode.
   */
  safe?: true;
  plugins_dir?: never;
  ...
  /**
   * A supported GitHub Pages Jekyll theme. Use remote_theme for other themes hosted on GitHub.
   */
  theme?: SupportedTheme | null;
  /**
   * A remote Jekyll theme hosted on GitHub, loaded by jekyll-remote-theme.
   */
  remote_theme?: string;
  /**
   * GitHub Pages supports kramdown and GitHub Flavored Markdown.
   */
  markdown?: 'kramdown' | 'GFM' | 'gfm' | 'CommonMarkGhPages' | 'commonmarkghpages';
  /**
   * GitHub Pages uses Rouge for syntax highlighting. Pygments falls back to Rouge.
   */
  highlighter?: 'rouge' | 'pygments';
  /**
   * GitHub Pages jekyll-gist configuration.
   */
  gist?: {
    /**
     * GitHub Pages sets gist.noscript to false.
     */
    noscript?: false;
    [k: string]: unknown | undefined;
  };
  /**
   * Kramdown options with values overridden by GitHub Pages narrowed where applicable.
   */
  kramdown?: {
    /**
     * GitHub Pages sets kramdown.template to an empty string.
     */
    template?: '';
    /**
     * GitHub Pages sets kramdown.math_engine to mathjax.
     */
    math_engine?: 'mathjax';
    /**
     * GitHub Pages sets kramdown.syntax_highlighter to Rouge.
     */
    syntax_highlighter?: 'rouge';
    /**
     * Options passed to Rouge by kramdown.
     */
    syntax_highlighter_opts?: {
      /**
       * Disable Jekyll syntax highlighting.
       */
      disable?: boolean;
      [k: string]: unknown | undefined;
    };
...
/**
 * A Jekyll plugin supported by GitHub Pages.
 */
export type SupportedPlugin =
  ...
  | 'jemoji';
/**
 * Plugins whitelisted by GitHub Pages.
 */
export type SupportedPluginList = SupportedPlugin[];
/**
 * A Jekyll theme included in the github-pages gem.
 */
