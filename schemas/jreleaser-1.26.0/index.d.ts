...
export type SubmissionType = 'SELF' | 'LINK';
...
export type Algorithm =
  ...
  | 'SHA3_384'
  | 'SHA3_512';
export type Stage1 = 'UPLOAD' | 'PUBLISH' | 'FULL';
export type Stage2 = 'UPLOAD' | 'CLOSE' | 'RELEASE';
export type Type1 = 'SOURCE' | 'THUMBNAIL';
export type DockerCommand = 'DOCKER' | 'PODMAN';
...
export type MakeLatest = 'FALSE' | 'TRUE' | 'LEGACY';
 ...
 * JReleaser 1.26.0
 */
export interface HttpsJsonSchemastoreOrgJreleaser1260Json {
  announce?: Announce;
  assemble?: Assemble;
  catalog?: Catalog;
  checksum?: Checksum;
  ...
  hooks?: Hooks;
  matrix?: Matrix;
  packagers?: PackagersPackagersObject;
  platform?: Platform;
  project?: Project;
  release?: Release;
  signing?: Signing;
...
export interface RedditAnnouncer {
  active?: Active;
  clientId?: string;
  clientSecret?: string;
  connectTimeout?: number;
...
export interface ZernioAnnouncer {
  active?: Active;
  apiHost?: string;
  connectTimeout?: number;
  extraProperties?: Properties;
...
export interface Assemble {
  ...
  deb?: MapStringDebAssembler &
    ({
      [k: string]: DebAssembler | undefined;
    } | null);
...
export interface Matrix {
  rows?: (StringProperties &
    ({
      [k: string]: string | undefined;
    } | null))[];
  vars?: MapStringListString &
    ({
      [k: string]: string[] | undefined;
    } | null);
}
export interface MapStringListString {
  /**
   * This interface was referenced by `MapStringListString`'s JSON-Schema definition
   * via the `patternProperty` "^[a-zA-Z][a-zA-Z0-9-]*[a-zA-Z0-9]?$".
   */
  [k: string]: string[] | undefined;
}
...
/**
 * This interface was referenced by `SwidTagMap`'s JSON-Schema definition
 * via the `patternProperty` "^[a-zA-Z][a-zA-Z0-9-]*[a-zA-Z0-9]?$".
 */
...
export interface MapStringDebAssembler {
  [k: string]: DebAssembler | undefined;
}
/**
 * This interface was referenced by `MapStringDebAssembler`'s JSON-Schema definition
 * via the `patternProperty` "^[a-zA-Z][a-zA-Z0-9-]*[a-zA-Z0-9]?$".
 */
export interface DebAssembler {
  active?: Active;
  architecture?: string;
  artifacts?: Artifact[];
  assemblerRef?: string;
...
export interface EnvironmentVariables {
  linux?: StringProperties &
    ({
      [k: string]: string | undefined;
    } | null);
  osx?: StringProperties &
    ({
      [k: string]: string | undefined;
    } | null);
  universal?: StringProperties &
    ({
      [k: string]: string | undefined;
    } | null);
  unix?: StringProperties &
    ({
      [k: string]: string | undefined;
    } | null);
  windows?: StringProperties &
    ({
      [k: string]: string | undefined;
    } | null);
}
...
export interface LinuxArm {
  args?: string[];
  platform?: string;
}
export interface LinuxX86 {
  args?: string[];
  platform?: string;
}
export interface MacosArm {
  args?: string[];
  platform?: string;
}
export interface MacosX86 {
  args?: string[];
  platform?: string;
}
...
export interface WindowsX86 {
  args?: string[];
  platform?: string;
}
export interface Catalog {
  active?: Active;
  github?: GithubCataloger;
  sbom?: Sbom;
  slsa?: SlsaCataloger;
  swid?: SwidTagMap &
    ({
      [k: string]: SwidTag | undefined;
    } | null);
}
export interface GithubCataloger {
  active?: Active;
  artifacts?: boolean;
...
export interface Maven {
  ...
  forgejo?: ForgejoMavenDeployerMap &
    ({
      [k: string]: ForgejoMavenDeployer | undefined;
    } | null);
  ...
  mavenCentral?: MavenCentralMavenDeployerMap &
    ({
      [k: string]: MavenCentralMavenDeployer | undefined;
    } | null);
  nexus2?: Nexus2MavenDeployerMap &
    ({
      [k: string]: Nexus2MavenDeployer | undefined;
    } | null);
  nexus3?: Nexus3MavenDeployerMap &
    ({
      [k: string]: Nexus3MavenDeployer | undefined;
    } | null);
...
export interface ForgejoMavenDeployerMap {
  [k: string]: ForgejoMavenDeployer | undefined;
}
/**
 * This interface was referenced by `ForgejoMavenDeployerMap`'s JSON-Schema definition
 * via the `patternProperty` "^[a-zA-Z][a-zA-Z0-9-]*[a-zA-Z0-9]?$".
 */
export interface ForgejoMavenDeployer {
  active?: Active;
  applyMavenCentralRules?: boolean;
  artifactOverrides?: ArtifactOverride[];
  authorization?: Authorization;
...
export interface MavenCentralMavenDeployerMap {
  [k: string]: MavenCentralMavenDeployer | undefined;
}
/**
 * This interface was referenced by `MavenCentralMavenDeployerMap`'s JSON-Schema definition
 * via the `patternProperty` "^[a-zA-Z][a-zA-Z0-9-]*[a-zA-Z0-9]?$".
 */
export interface MavenCentralMavenDeployer {
  active?: Active;
  applyMavenCentralRules?: boolean;
  artifactOverrides?: ArtifactOverride[];
  authorization?: Authorization;
...
export interface Nexus3MavenDeployerMap {
  [k: string]: Nexus3MavenDeployer | undefined;
}
/**
 * This interface was referenced by `Nexus3MavenDeployerMap`'s JSON-Schema definition
 * via the `patternProperty` "^[a-zA-Z][a-zA-Z0-9-]*[a-zA-Z0-9]?$".
 */
export interface Nexus3MavenDeployer {
  active?: Active;
  applyMavenCentralRules?: boolean;
  artifactOverrides?: ArtifactOverride[];
  authorization?: Authorization;
...
export interface SnapPackager {
  ...
  localSlots?: string[];
  packageName?: string;
  platforms?: MapStringArchitecture &
    ({
      [k: string]: Architecture | undefined;
    } | null);
  plugs?: Plug[];
  remoteBuild?: boolean;
...
/**
 * This interface was referenced by `MapStringArchitecture`'s JSON-Schema definition
 * via the `patternProperty` "^[a-zA-Z][a-zA-Z0-9-]*[a-zA-Z0-9]?$".
 */
...
export interface MapStringArchitecture {
  [k: string]: Architecture | undefined;
}
...
export interface CommandHooks {
  ...
  failure?: CommandHook[];
  groups?: NamedCommandHooksMap &
    ({
      [k: string]: NamedCommandHooks | undefined;
    } | null);
  matrix?: Matrix;
  success?: CommandHook[];
}
...
export interface NamedCommandHooksMap {
  [k: string]: NamedCommandHooks | undefined;
}
/**
 * This interface was referenced by `NamedCommandHooksMap`'s JSON-Schema definition
 * via the `patternProperty` "^[a-zA-Z][a-zA-Z0-9-]*[a-zA-Z0-9]?$".
 */
export interface NamedCommandHooks {
  active?: Active;
  applyDefaultMatrix?: boolean;
  before?: CommandHook[];
  condition?: string;
...
export interface JbangHooks {
  ...
  failure?: JbangHook[];
  groups?: NamedJbangHooksMap &
    ({
      [k: string]: NamedJbangHooks | undefined;
    } | null);
  matrix?: Matrix;
  success?: JbangHook[];
  version?: string;
}
export interface JbangHook {
  active?: Active;
  applyDefaultMatrix?: boolean;
  args?: string[];
  condition?: string;
...
export interface NamedJbangHooksMap {
  [k: string]: NamedJbangHooks | undefined;
}
/**
 * This interface was referenced by `NamedJbangHooksMap`'s JSON-Schema definition
 * via the `patternProperty` "^[a-zA-Z][a-zA-Z0-9-]*[a-zA-Z0-9]?$".
 */
export interface NamedJbangHooks {
  active?: Active;
  applyDefaultMatrix?: boolean;
  before?: JbangHook[];
  condition?: string;
...
export interface ScriptHooks {
  ...
  failure?: ScriptHook[];
  groups?: NamedScriptHooksMap &
    ({
      [k: string]: NamedScriptHooks | undefined;
    } | null);
  matrix?: Matrix;
  success?: ScriptHook[];
}
...
export interface NamedScriptHooksMap {
  [k: string]: NamedScriptHooks | undefined;
}
/**
 * This interface was referenced by `NamedScriptHooksMap`'s JSON-Schema definition
 * via the `patternProperty` "^[a-zA-Z][a-zA-Z0-9-]*[a-zA-Z0-9]?$".
 */
export interface NamedScriptHooks {
  active?: Active;
  applyDefaultMatrix?: boolean;
  before?: ScriptHook[];
  condition?: string;
...
export interface PackagersPackagersObject {
  active?: Active;
  appImage?: AppImagePackager;
  asdf?: AsdfPackager;
  brew?: BrewPackager;
...
export interface ForgejoReleaser {
  apiEndpoint?: string;
  artifacts?: boolean;
  branch?: string;
  branchPush?: string;
...
export interface Upload {
  ...
  forgejo?: ForgejoUploaderMap &
    ({
      [k: string]: ForgejoUploader | undefined;
    } | null);
  ftp?: FtpUploaderMap &
    ({
...
export interface ForgejoUploaderMap {
  [k: string]: ForgejoUploader | undefined;
}
/**
 * This interface was referenced by `ForgejoUploaderMap`'s JSON-Schema definition
 * via the `patternProperty` "^[a-zA-Z][a-zA-Z0-9-]*[a-zA-Z0-9]?$".
 */
export interface ForgejoUploader {
  active?: Active;
  artifacts?: boolean;
  catalogs?: boolean;
  checksums?: boolean;
