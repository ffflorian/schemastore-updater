...
/**
 * The JSON schema for the "eventConfiguration" field on an event group's event.
 */
...
/**
 * The JSON schema for the "eventGroupConfiguration" field on an event group.
 */
...
/**
 * The JSON schema for the "datasetConfiguration" field on a dataset.
 */
...
/**
 * The JSON schema for the "dataPointConfiguration" field on a dataset's datapoint.
 */
...
/**
 * The JSON schema for the "managementGroupConfiguration" field on a management group.
 */
...
/**
 * The JSON schema for the "actionConfiguration" field on a management group's action.
 */
...
/**
 * The JSON schema for the "streamConfiguration" field on a stream.
 */
 ...
 */
export interface JSONSchemaForAzureIoTOperationsConnectorMetadata100Preview {
  /**
   ...
   * @minItems 1
   */
  supportedArchitectures: [string, ...string[]];
  /**
  ...
  inboundEndpoints: [
    {
      /**
       * A human readable description of this inbound endpoint
       */
      description?: string;
      /**
      ...
      version?: string;
      /**
       * If present, this connector supports using event groups.
       */
      eventGroups?: {
        limits: ModelLimits;
        /**
        ...
        events?: {
          limits: ModelLimits;
          eventConfigurationSchema?: CoreSchemaMetaSchema1;
        ...
        eventGroupConfigurationSchema?: CoreSchemaMetaSchema2;
        /**
         * Describes if this connector expects these fields to be provided in the event definition when deploying the connector. Also describes the expected shape of these values if they are supported.
         */
        fields: {
      ...
      managementGroups?: {
        ...
        managementGroupActions?: {
          ...
          /**
           * Information about the supported action types for management group actions
           */
          actionTypes: {
            /**
             * The array of action types that this asset's management group supports.
             *
             * @minItems 1
             */
            supportedActionTypes: ['Call' | 'Read' | 'Write', ...('Call' | 'Read' | 'Write')[]];
          };
        };
        /**
...
export interface StorageDestinationDefaults {
  destination: 'Storage';
  /**
   * The default path that storage will use. Values are allowed to contain deploy-time parameters like 'storage/{deviceName}/{inboundEndpointName}'.  The supported parameter tokens are: {deviceName}, {inboundEndpointName}, {assetName}, {datasetName}, {eventGroupName}, {eventName}, {streamName}, and {kubernetesNamespace}. Dataset/eventGroup/event/stream name tokens are only allowed if the configured destination is for a dataset/event/stream.
   */
  path: string;
}
/**
