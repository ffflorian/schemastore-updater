...
export interface HttpsJsonSchemastoreOrgAirlockMicrogateway32Json {
   ...
   */
  deny_rule_groups?: DeniedRuleGroups1[];
...
export interface Mapping {
  ...
  deny_rule_groups?: DeniedRuleGroups[];
  /**
  ...
  request?: {
    ...
    default_actions?: DtoAction[] | null;
  } | null;
  response?: {
    /**
     * A list of request custom actions executed in order of appearance. Only one action type (e.g. add_header or header_redirect) can be specified in each entry. Create multiple list positions if needed.
     ...
     */
    error_page_replacements?: ErrorPageReplacement[] | null;
    rewrites?: {
      /**
   ...
   */
  session_handling?: null | ('enforce_session' | 'optional_session' | 'optional_session_no_refresh' | 'ignore_session');
  /**
...
export interface DeniedRuleGroups {
  /**
...
export interface ErrorPageReplacement {
  /**
