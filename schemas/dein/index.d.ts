...
export interface OnMapDict {
  /**
   * Pattern for vim key binding. You can use plugin prefix mappings. You can use '<Plug>' keyword as {mapping}. If{mapping} is '<Plug>', '<Plug>(normalized_name' is used. linter support is now under development
   *
