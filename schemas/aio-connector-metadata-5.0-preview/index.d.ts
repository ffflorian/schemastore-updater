...
export type CoreSchemaMetaSchema =
  | {
      ...
      definitions?: {
        [k: string]: CoreSchemaMetaSchema | undefined;
      };
      properties?: {
        [k: string]: CoreSchemaMetaSchema | undefined;
      };
 ...
 */
export interface JSONSchemaForAzureIoTOperationsConnectorMetadata50Preview {
  /**
   ...
   * @minItems 1
   *
   * Items: A single secret that will be mounted onto all connector instances.
   */
  secrets?: [
    {
      /**
   ...
   * @minItems 1
   *
   * Items: A single storage volume is needed.
   */
  storageVolumes?: [
    {
      /**
   ...
   * @minItems 1
   *
   * Items: One of the CPU architectures this connector image was built for. For example: 'linux/amd64', 'linux/arm64', or 'windows/amd64'
   */
  ...
  inboundEndpoints: [
    {
      ...
      version?: string;
      /**
       * The list of models that this connector supports using and additional details for how to use each model. If a model type is not present, that indicates this connector doesn't support using that model at all. A connector must support at least one type of modeling. A connector may support more than one type of modeling.
       */
      supportedModeling?: {
        /**
        ...
        datasets?: {
          limits: ModelLimits;
          datasetConfigurationSchema?: CoreSchemaMetaSchema;
          /**
           * The list of dataset-specific models that this connector supports using and additional details for how to use each model. If a model type is not present, that indicates this connector doesn't support using that model at all. If this field isn't present, then this connector does not support modeling of any sub-dataset types like dataset datapoints.
           */
          supportedModeling?: {
            /**
          ...
          destinations?: {
             ...
             */
            defaultDestination?:
              MqttDestinationDefaults | StorageDestinationDefaults | BrokerStateStoreDestinationDefaults;
          };
        };
        /**
        ...
        managementGroups?: {
          ...
          alternativeTypeName?: AlternativeTypeName;
          /**
           * The list of management group-specific models that this connector supports using and additional details for how to use each model. If a model type is not present, that indicates this connector doesn't support using that model at all. If this field isn't present, then this connector does not support modeling of any sub-management group types like management group actions.
           */
          supportedModeling?: {
            /**
...
export interface MqttDestinationDefaults {
  destination: 'Mqtt';
  /**
   * The default MQTT topic that will be published to
   */
  topic: string;
  /**
...
export interface StorageDestinationDefaults {
  destination: 'Storage';
  /**
   * The default path that storage will use
   */
  path: string;
}
/**
...
export interface BrokerStateStoreDestinationDefaults {
  ...
  /**
   * The default broker state store key that will be published to
   */
  key: string;
}
