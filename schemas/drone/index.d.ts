...
export interface KindPipeline {
  kind?: 'pipeline';
  name: NonEmptyString;
  type: 'docker' | 'kubernetes' | 'ssh' | 'exec' | 'digitalocean' | 'macstadium' | 'vm';
  platform?: Platform;
  workspace?: {
    path: NonEmptyString;
    [k: string]: unknown | undefined;
  ...
  clone?: {
    /**
     * If empty the full repository may be cloned
     * https://docs.drone.io/yaml/exec/#the-clone-object
     */
    depth?: number;
    /**
     * It can be useful when you need to disable implement your own custom clone logic.
     * https://docs.drone.io/yaml/exec/#the-clone-object
     */
    disable?: boolean;
    [k: string]: unknown | undefined;
...
export interface Concurrency {
  /**
   * Defines the concurrency limits for the named pipeline
