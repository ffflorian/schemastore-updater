...
/**
 * YAML descriptor for Enonic XP Content Types.
 * https://developer.enonic.com/docs/cms/stable/content/content-types
 */
export interface HttpsJsonSchemastoreOrgEnonicXpContentType800B5Json {
  kind: 'ContentType';
  superType?: string;
  abstract?: boolean;
  final?: boolean;
  ...
  displayNamePlaceholder?: LocalizedTextDef;
