...
export type FormItemsDef = InputsDef | FieldSetDef | ItemSetDef | OptionSetDef;
...
/**
 * YAML descriptor for Enonic XP ID Providers.
 * https://developer.enonic.com/docs/code/stable/http/id-providers
 */
export interface HttpsJsonSchemastoreOrgEnonicXpIdprovider800B5Json {
  kind: 'IdProvider';
