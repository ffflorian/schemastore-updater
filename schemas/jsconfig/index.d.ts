...
export interface CompilerOptionsDefinition {
  ...
  compilerOptions?: {
     ...
     */
    module?: "commonjs" | "amd" | "umd" | "system" | "es6" | "es2015";
    /**
    ...
    /**
     * When down-level compiling, specifies the end of line sequence to be used when emitting files: 'CRLF' (dos) or 'LF' (unix).
     */
    newLine?: "CRLF" | "LF";
    /**
