...
export type InstallerType =
  ('msix' | 'msi' | 'appx' | 'exe' | 'zip' | 'inno' | 'nullsoft' | 'wix' | 'burn' | 'pwa') | null;
/**
...
export type InstallModes =
  [] | [InstallModes1] | [InstallModes1, InstallModes1] | [InstallModes1, InstallModes1, InstallModes1] | null;
...
/**
 * A representation of a single-file manifest representing an app installers in the OWC. v1.0.0
 */
export interface HttpsAkaMsWingetManifestInstaller100SchemaJson {
  PackageIdentifier: PackageIdentifier;
