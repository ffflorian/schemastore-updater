 ...
 */
export type ShowQuantitiesAs1 = 'Units' | 'Lots' | 'Cost';
/**
...
export interface ABCSupplyPlanJSONSchema {
  /**
   * Link to https://www.schemastore.org/abc-supply-plan-7.0.0.json
   */
  $schema: 'https://www.schemastore.org/abc-supply-plan-7.0.0.json';
  planDate: PlanDate;
  planNotes: PlanNotes;
  analytics: {
    items: AnalyticsItem[];
...
export interface TimeSeries {
  ...
  subtitle: string;
  /**
   * Number of months to exclude from the end of the time series
   */
