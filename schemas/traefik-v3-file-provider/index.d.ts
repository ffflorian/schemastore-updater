 ...
 */
export interface HttpsJsonSchemastoreOrgTraefikV3FileProviderJson {
  http?: {
    routers?: {
 ...
 */
export interface GrpcWebMiddleware {
  /**
 ...
 */
export interface IpAllowListMiddleware {
  /**
   * The sourceRange option sets the allowed IPs (or ranges of allowed IPs by using CIDR notation).
   */
  sourceRange?: string[];
