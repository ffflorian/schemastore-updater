...
export type MySqlBinding1 =
  | {
      ...
      commandText?: string;
      /**
       * Whether the commandText is a query or a stored procedure.
       */
      commandType?: 'text' | 'storedProcedure';
      /**
       * The parameters to the query or stored procedure.
