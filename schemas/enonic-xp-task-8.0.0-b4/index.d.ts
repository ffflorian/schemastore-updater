...
/**
 * YAML descriptor for Enonic XP Tasks.
 * https://developer.enonic.com/docs/code/stable/background/tasks
 */
export interface HttpsJsonSchemastoreOrgEnonicXpTask800B4Json {
  kind: 'Task';
