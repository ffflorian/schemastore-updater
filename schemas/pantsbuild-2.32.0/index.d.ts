 ...
 */
export interface HttpsJsonSchemastoreOrgPantsbuild2320Json {
  /**
  ...
  GLOBAL?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#allow_deprecated_macos_versions
     */
    allow_deprecated_macos_versions?: unknown[];
    /**
     * Register functionality from these backends
     * https://www.pantsbuild.org/v2.32/docs/reference-global#backend_packages
     */
    backend_packages?: unknown[];
    /**
     * Python files to evaluate and whose symbols should be exposed to all BUILD files
     * https://www.pantsbuild.org/v2.32/docs/reference-global#build_file_prelude_globs
     */
    build_file_prelude_globs?: unknown[];
    /**
     * Path globs or literals to ignore when identifying BUILD files
     * https://www.pantsbuild.org/v2.32/docs/reference-global#build_ignore
     */
    build_ignore?: unknown[];
    /**
     * The naming scheme for BUILD files, i.e. where you define targets
     * https://www.pantsbuild.org/v2.32/docs/reference-global#build_patterns
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#ca_certs_path
     */
    ca_certs_path?: string;
    /**
     * Controls how the content of cache entries is handled during process execution
     * https://www.pantsbuild.org/v2.32/docs/reference-global#cache_content_behavior
     */
    cache_content_behavior?: 'fetch' | 'validate' | 'defer';
    /**
     * Whether Pants should use colors in output or not
     * https://www.pantsbuild.org/v2.32/docs/reference-global#colors
     */
    colors?: boolean;
    /**
     * Enable concurrent runs of Pants
     * https://www.pantsbuild.org/v2.32/docs/reference-global#concurrent
     */
    concurrent?: boolean;
    /**
     * If true, `docker_environment` targets can be used to run builds inside a Docker container
     * https://www.pantsbuild.org/v2.32/docs/reference-global#docker_execution
     */
    docker_execution?: boolean;
    /**
     * Display a dynamically-updating console UI as Pants runs
     * https://www.pantsbuild.org/v2.32/docs/reference-global#dynamic_ui
     */
    dynamic_ui?: boolean;
    /**
     * If `--dynamic-ui` is enabled, selects the renderer
     * https://www.pantsbuild.org/v2.32/docs/reference-global#dynamic_ui_renderer
     */
    dynamic_ui_renderer?: 'indicatif-spinner' | 'experimental-prodash';
    /**
     * Enable `sys.activate_stack_trampoline` for Pants's own Python
     * https://www.pantsbuild.org/v2.32/docs/reference-global#enable_stack_trampoline
     */
    enable_stack_trampoline?: string;
    /**
     * Enable fine grained target analysis based on line numbers
     * https://www.pantsbuild.org/v2.32/docs/reference-global#enable_target_origin_sources_blocks
     */
    enable_target_origin_sources_blocks?: boolean;
    /**
     * A directory to write execution and rule graphs to as `dot` files
     * https://www.pantsbuild.org/v2.32/docs/reference-global#engine_visualize_to
     */
    engine_visualize_to?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#file_downloads_max_attempts
     */
    file_downloads_max_attempts?: number;
    /**
     * When Pants downloads files (for example, for the `http_source` source), Pants will retry the download if a "retryable" error occurs
     * https://www.pantsbuild.org/v2.32/docs/reference-global#file_downloads_retry_delay
     */
    file_downloads_retry_delay?: number;
    /**
     * Ignore logs and warnings matching these strings
     * https://www.pantsbuild.org/v2.32/docs/reference-global#ignore_warnings
     */
    ignore_warnings?: unknown[];
    /**
     * Controls whether Pants will clean up local directories used as chroots for running processes
     * https://www.pantsbuild.org/v2.32/docs/reference-global#keep_sandboxes
     */
    keep_sandboxes?: 'always' | 'on_failure' | 'never';
    /**
     * Set the logging level
     * https://www.pantsbuild.org/v2.32/docs/reference-global#level
     */
    level?: 'trace' | 'debug' | 'info' | 'warn' | 'error';
    /**
     * Whether to cache process executions in a local cache persisted to disk at `--local-store-dir`
     * https://www.pantsbuild.org/v2.32/docs/reference-global#local_cache
     */
    local_cache?: boolean;
    /**
     * Directory to use for local process execution sandboxing
     * https://www.pantsbuild.org/v2.32/docs/reference-global#local_execution_root_dir
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#log_show_rust_3rdparty
     */
    log_show_rust_3rdparty?: boolean;
    /**
     * Write logs to files under this directory
     * https://www.pantsbuild.org/v2.32/docs/reference-global#logdir
     */
    logdir?: string;
    /**
     * Run goals continuously as file changes are detected
     * https://www.pantsbuild.org/v2.32/docs/reference-global#loop
     */
    loop?: boolean;
    /**
     * The maximum number of times to loop when `--loop` is specified
     * https://www.pantsbuild.org/v2.32/docs/reference-global#loop_max
     */
    loop_max?: number;
    /**
     * Directory to use for named global caches for tools and processes with trusted, concurrency-safe caches
     * https://www.pantsbuild.org/v2.32/docs/reference-global#named_caches_dir
     */
    named_caches_dir?: string;
    /**
     * The name of the script or binary used to invoke Pants
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pants_bin_name
     */
    pants_bin_name?: string;
    /**
     * Paths to Pants config files
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pants_config_files
     */
    pants_config_files?: unknown[];
    /**
     * Write end products, such as the results of `pants package`, to this dir
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pants_distdir
     */
    pants_distdir?: string;
    /**
     * Paths to ignore for all filesystem operations performed by pants (e.g
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pants_ignore
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pants_ignore_use_gitignore
     */
    pants_ignore_use_gitignore?: boolean;
    /**
     * When set, a base directory in which to store `--pants-workdir` contents
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pants_physical_workdir_base
     */
    pants_physical_workdir_base?: string;
    /**
     * The directory to use for tracking subprocess metadata
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pants_subprocessdir
     */
    pants_subprocessdir?: string;
    /**
     * Use this Pants version
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pants_version
     */
    pants_version?: string;
    /**
     * Write intermediate logs and output files to this dir
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pants_workdir
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pantsd
     */
    pantsd?: boolean;
    /**
     * Filesystem events matching any of these globs will trigger a daemon restart
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pantsd_invalidation_globs
     */
    pantsd_invalidation_globs?: unknown[];
    /**
     * The maximum memory usage of the pantsd process
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pantsd_max_memory_usage
     */
    pantsd_max_memory_usage?: string;
    /**
     * The port to bind the Pants nailgun server to
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pantsd_pailgun_port
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pantsrc
     */
    pantsrc?: boolean;
    /**
     * Override config with values from these files, using syntax matching that of `--pants-config-files`
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pantsrc_files
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#plugins
     */
    plugins?: unknown[];
    /**
     * Re-resolve plugins, even if previously resolved
     * https://www.pantsbuild.org/v2.32/docs/reference-global#plugins_force_resolve
     */
    plugins_force_resolve?: boolean;
    /**
     * Print the full exception stack trace for any errors
     * https://www.pantsbuild.org/v2.32/docs/reference-global#print_stacktrace
     */
    print_stacktrace?: boolean;
    /**
     * The cache namespace for process execution
     * https://www.pantsbuild.org/v2.32/docs/reference-global#process_execution_cache_namespace
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#process_execution_graceful_shutdown_timeout
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#process_execution_local_enable_nailgun
     */
    process_execution_local_enable_nailgun?: boolean;
    /**
     * Number of concurrent processes that may be executed locally
     * https://www.pantsbuild.org/v2.32/docs/reference-global#process_execution_local_parallelism
     */
    process_execution_local_parallelism?: number & string;
    /**
     * Number of concurrent processes that may be executed remotely
     * https://www.pantsbuild.org/v2.32/docs/reference-global#process_execution_remote_parallelism
     */
    process_execution_remote_parallelism?: number;
    /**
     * The default memory usage for a single "pooled" child process
     * https://www.pantsbuild.org/v2.32/docs/reference-global#process_per_child_memory_usage
     */
    process_per_child_memory_usage?: string;
    /**
     * The maximum memory usage for all "pooled" child processes
     * https://www.pantsbuild.org/v2.32/docs/reference-global#process_total_child_memory_usage
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#pythonpath
     */
    pythonpath?: unknown[];
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#remote_client_certs_path
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#remote_client_key_path
     */
    remote_client_key_path?: string;
    /**
     * Enables remote workers for increased parallelism. (Alpha)
     * https://www.pantsbuild.org/v2.32/docs/reference-global#remote_execution
     */
    remote_execution?: boolean;
    /**
     * The URI of a server/entity used as a remote execution scheduler
     * https://www.pantsbuild.org/v2.32/docs/reference-global#remote_execution_address
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#remote_oauth_bearer_token
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#remote_provider
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#remote_store_address
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#rule_threads_core
     */
    rule_threads_core?: number & string;
    /**
     * The maximum number of threads to use to execute `@rule` logic
     * https://www.pantsbuild.org/v2.32/docs/reference-global#rule_threads_max
     */
    rule_threads_max?: number;
    /**
     * Enables use of the sandboxer process
     * https://www.pantsbuild.org/v2.32/docs/reference-global#sandboxer
     */
    sandboxer?: boolean;
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#session_end_tasks_timeout
     */
    session_end_tasks_timeout?: number;
    /**
     * Display the target where a log message originates in that log message's output
     * https://www.pantsbuild.org/v2.32/docs/reference-global#show_log_target
     */
    show_log_target?: boolean;
    /**
     * Read additional specs (target addresses, files, and/or globs), one per line, from these files
     * https://www.pantsbuild.org/v2.32/docs/reference-global#spec_files
     */
    spec_files?: unknown[];
    /**
     * Option scopes to record in stats on run completion
     * https://www.pantsbuild.org/v2.32/docs/reference-global#stats_record_option_scopes
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#streaming_workunits_complete_async
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#streaming_workunits_level
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-global#streaming_workunits_report_interval
     */
  ...
  'anonymous-telemetry'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-anonymous-telemetry#enabled
     */
    enabled?: boolean;
    /**
     * An anonymized ID representing this repo
     * https://www.pantsbuild.org/v2.32/docs/reference-anonymous-telemetry#repo_id
     */
    repo_id?: string;
    [k: string]: unknown | undefined;
  };
  ...
  autoflake?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-autoflake#args
     */
    args?: unknown[];
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-autoflake#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-autoflake#entry_point
     */
    entry_point?: string;
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-autoflake#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * Python interpreter constraints for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-autoflake#interpreter_constraints
     */
    interpreter_constraints?: unknown[];
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-autoflake#requirements
     */
    requirements?: unknown[];
    /**
     * If true, don't use Autoflake when running `pants fmt` and `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-autoflake#skip
     */
    skip?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  black?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-black#args
     */
    args?: unknown[];
    /**
     * Path to a TOML config file understood by Black (https://github.com/psf/black#configuration-format)
     * https://www.pantsbuild.org/v2.32/docs/reference-black#config
     */
    config?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-black#config_discovery
     */
    config_discovery?: boolean;
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-black#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-black#entry_point
     */
    entry_point?: string;
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-black#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * Python interpreter constraints for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-black#interpreter_constraints
     */
    interpreter_constraints?: unknown[];
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-black#requirements
     */
    requirements?: unknown[];
    /**
     * If true, don't use Black when running `pants fmt` and `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-black#skip
     */
    skip?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  'build-deprecations-fixer'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-build-deprecations-fixer#skip
     */
    skip?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  buildifier?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-buildifier#args
     */
    args?: unknown[];
    /**
     * Known versions to verify downloads against
     * https://www.pantsbuild.org/v2.32/docs/reference-buildifier#known_versions
     */
    known_versions?: unknown[];
    /**
     * If true, don't use Buildifier when running `pants fmt`
     * https://www.pantsbuild.org/v2.32/docs/reference-buildifier#skip
     */
    skip?: boolean;
    /**
     * A dictionary mapping platforms to strings to be used when generating the URL to download the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-buildifier#url_platform_mapping
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-buildifier#url_template
     */
    url_template?: string;
    /**
     * What action to take in case the requested version of Buildifier is not supported
     * https://www.pantsbuild.org/v2.32/docs/reference-buildifier#use_unsupported_version
     */
    use_unsupported_version?: 'error' | 'warning';
    /**
     * Use this version of Buildifier
     * https://www.pantsbuild.org/v2.32/docs/reference-buildifier#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  changed?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-changed#dependents
     */
    dependents?: 'none' | 'direct' | 'transitive';
    /**
     * Calculate changes contained within a given Git spec (commit range/SHA/ref)
     * https://www.pantsbuild.org/v2.32/docs/reference-changed#diffspec
     */
    diffspec?: string;
    /**
     * Calculate changes since this Git spec (commit range/SHA/ref)
     * https://www.pantsbuild.org/v2.32/docs/reference-changed#since
     */
    since?: string;
    [k: string]: unknown | undefined;
  };
  ...
  check?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-check#force
     */
    force?: boolean;
    /**
     * Only run these checkers and skip all others
     * https://www.pantsbuild.org/v2.32/docs/reference-check#only
     */
    only?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  cli?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-cli#alias
     */
    alias?: {
      [k: string]: unknown | undefined;
    };
  ...
  complete?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-complete#shell
     */
    shell?: 'bash' | 'zsh';
    [k: string]: unknown | undefined;
  };
  ...
  coursier?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-coursier#jvm_index
     */
    jvm_index?: string;
    /**
     * Known versions to verify downloads against
     * https://www.pantsbuild.org/v2.32/docs/reference-coursier#known_versions
     */
    known_versions?: unknown[];
    /**
     * Maven style repositories to resolve artifacts from
     * https://www.pantsbuild.org/v2.32/docs/reference-coursier#repos
     */
    repos?: unknown[];
    /**
     * A dictionary mapping platforms to strings to be used when generating the URL to download the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-coursier#url_platform_mapping
     */
    url_platform_mapping?: {
      [k: string]: unknown | undefined;
    };
    /**
     * URL to download the tool, either as a single binary file or a compressed file (e.g. zip file)
     * https://www.pantsbuild.org/v2.32/docs/reference-coursier#url_template
     */
    url_template?: string;
    /**
     * What action to take in case the requested version of coursier is not supported
     * https://www.pantsbuild.org/v2.32/docs/reference-coursier#use_unsupported_version
     */
    use_unsupported_version?: 'error' | 'warning';
    /**
     * Use this version of coursier
     * https://www.pantsbuild.org/v2.32/docs/reference-coursier#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  'coverage-py'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-coverage-py#config
     */
    config?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-coverage-py#config_discovery
     */
    config_discovery?: boolean;
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-coverage-py#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-coverage-py#entry_point
     */
    entry_point?: string;
    /**
     * Fail if the total combined coverage percentage for all tests is less than this number
     * https://www.pantsbuild.org/v2.32/docs/reference-coverage-py#fail_under
     */
    fail_under?: number;
    /**
     * A list of Python modules or filesystem paths to use in the coverage report, e.g. `['helloworld_test', 'helloworld/util/dirutil']`
     * https://www.pantsbuild.org/v2.32/docs/reference-coverage-py#filter
     */
    filter?: unknown[];
    /**
     * If true, Pants will generate a global coverage report
     * https://www.pantsbuild.org/v2.32/docs/reference-coverage-py#global_report
     */
    global_report?: boolean;
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-coverage-py#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * Python interpreter constraints for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-coverage-py#interpreter_constraints
     */
    interpreter_constraints?: unknown[];
    /**
     * Path to write the Pytest Coverage report to
     * https://www.pantsbuild.org/v2.32/docs/reference-coverage-py#output_dir
     */
    output_dir?: string;
    /**
     * Which coverage report type(s) to emit
     * https://www.pantsbuild.org/v2.32/docs/reference-coverage-py#report
     */
    report?: 'console' | 'xml' | 'html' | 'raw' | 'json' | 'lcov';
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-coverage-py#requirements
     */
    requirements?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  'debug-adapter'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-debug-adapter#host
     */
    host?: string;
    /**
     * The port to use when launching the server
     * https://www.pantsbuild.org/v2.32/docs/reference-debug-adapter#port
     */
    port?: number;
    [k: string]: unknown | undefined;
  };
  ...
  debugpy?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-debugpy#args
     */
    args?: unknown[];
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-debugpy#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-debugpy#entry_point
     */
    entry_point?: string;
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-debugpy#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * Python interpreter constraints for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-debugpy#interpreter_constraints
     */
    interpreter_constraints?: unknown[];
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-debugpy#requirements
     */
    requirements?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  dependencies?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-dependencies#closed
     */
    closed?: boolean;
    /**
     * Output format for listing dependencies
     * https://www.pantsbuild.org/v2.32/docs/reference-dependencies#format
     */
    format?: 'text' | 'json';
    /**
     * Output the goal's stdout to this file
     * https://www.pantsbuild.org/v2.32/docs/reference-dependencies#output_file
     */
    output_file?: string;
    /**
     * String to use to separate lines in line-oriented output
     * https://www.pantsbuild.org/v2.32/docs/reference-dependencies#sep
     */
    sep?: string;
    /**
     * List all transitive dependencies
     * https://www.pantsbuild.org/v2.32/docs/reference-dependencies#transitive
     */
    transitive?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  dependents?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-dependents#closed
     */
    closed?: boolean;
    /**
     * Output format for listing dependents
     * https://www.pantsbuild.org/v2.32/docs/reference-dependents#format
     */
    format?: 'text' | 'json';
    /**
     * Output the goal's stdout to this file
     * https://www.pantsbuild.org/v2.32/docs/reference-dependents#output_file
     */
    output_file?: string;
    /**
     * String to use to separate lines in line-oriented output
     * https://www.pantsbuild.org/v2.32/docs/reference-dependents#sep
     */
    sep?: string;
    /**
     * List all transitive dependents
     * https://www.pantsbuild.org/v2.32/docs/reference-dependents#transitive
     */
    transitive?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  docformatter?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-docformatter#args
     */
    args?: unknown[];
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-docformatter#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-docformatter#entry_point
     */
    entry_point?: string;
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-docformatter#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * Python interpreter constraints for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-docformatter#interpreter_constraints
     */
    interpreter_constraints?: unknown[];
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-docformatter#requirements
     */
    requirements?: unknown[];
    /**
     * If true, don't use docformatter when running `pants fmt` and `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-docformatter#skip
     */
    skip?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  docker?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#build_args
     */
    build_args?: unknown[];
    /**
     * Hosts entries to be added to the `/etc/hosts` file in all built images
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#build_hosts
     */
    build_hosts?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#build_no_cache
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#build_target_stage
     */
    build_target_stage?: string;
    /**
     * Whether to log the Docker output to the console
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#build_verbose
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#default_context_root
     */
    default_context_root?: string;
    /**
     * Configure the default repository name used in the Docker image tag
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#default_repository
     */
    default_repository?: string;
    /**
     * Environment variables to set for `docker` invocations
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#env_vars
     */
    env_vars?: unknown[];
    /**
     * The PATH value that will be used to find the Docker client and any tools required
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#executable_search_paths
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#optional_tools
     */
    optional_tools?: unknown[];
    /**
     * If true, publish images non-interactively
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#publish_noninteractively
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#push_on_package
     */
    push_on_package?: 'allow' | 'ignore' | 'warn' | 'error';
    /**
     * Configure Docker registries
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#registries
     */
    registries?:
      | {
          [k: string]: unknown | undefined;
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#run_args
     */
    run_args?: unknown[];
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#suggest_renames
     */
    suggest_renames?: boolean;
    /**
     * If true, add `docker_image` targets with the `tailor` goal
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#tailor
     */
    tailor?: boolean;
    /**
     * List any additional executable tools required for Docker to work
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#tools
     */
    tools?: unknown[];
    /**
     * Use [buildx](https://github.com/docker/buildx#buildx) (and BuildKit) for builds
     * https://www.pantsbuild.org/v2.32/docs/reference-docker#use_buildx
     */
    use_buildx?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  'dockerfile-parser'?: {
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-dockerfile-parser#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * Python interpreter constraints for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-dockerfile-parser#interpreter_constraints
     */
    interpreter_constraints?: unknown[];
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-dockerfile-parser#requirements
     */
    requirements?: unknown[];
    /**
     * Use the new Rust-based, multithreaded, in-process dependency parser
     * https://www.pantsbuild.org/v2.32/docs/reference-dockerfile-parser#use_rust_parser
     */
  ...
  'environments-preview'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-environments-preview#names
     */
    names?: {
      [k: string]: unknown | undefined;
    };
  ...
  'experimental-deploy'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-experimental-deploy#dry_run
     */
    dry_run?: boolean;
    /**
     * If false, don't publish target dependencies before deploying the target
     * https://www.pantsbuild.org/v2.32/docs/reference-experimental-deploy#publish_dependencies
     */
  ...
  'experimental-explorer'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-experimental-explorer#address
     */
    address?: string;
    /**
     * Server port to bind to
     * https://www.pantsbuild.org/v2.32/docs/reference-experimental-explorer#port
     */
    port?: number;
    [k: string]: unknown | undefined;
  };
  ...
  export?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-export#bin
     */
    bin?: unknown[];
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-export#py_editable_in_resolve
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-export#py_generated_sources_in_resolve
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-export#py_non_hermetic_scripts_in_resolve
     */
    py_non_hermetic_scripts_in_resolve?: unknown[];
    /**
     * Export Python resolves using this format
     * https://www.pantsbuild.org/v2.32/docs/reference-export#py_resolve_format
     */
    py_resolve_format?: 'mutable_virtualenv' | 'symlinked_immutable_virtualenv';
    /**
     * Export the specified resolve(s)
     * https://www.pantsbuild.org/v2.32/docs/reference-export#resolve
     */
    resolve?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  filedeps?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-filedeps#absolute
     */
    absolute?: boolean;
    /**
     * Instead of outputting filenames, output the original globs used in the BUILD file
     * https://www.pantsbuild.org/v2.32/docs/reference-filedeps#globs
     */
    globs?: boolean;
    /**
     * Output the goal's stdout to this file
     * https://www.pantsbuild.org/v2.32/docs/reference-filedeps#output_file
     */
    output_file?: string;
    /**
     * String to use to separate lines in line-oriented output
     * https://www.pantsbuild.org/v2.32/docs/reference-filedeps#sep
     */
    sep?: string;
    /**
     * If True, list files from all dependencies, including transitive dependencies
     * https://www.pantsbuild.org/v2.32/docs/reference-filedeps#transitive
     */
    transitive?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  filter?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-filter#address_regex
     */
    address_regex?: unknown[];
    /**
     * Filter to rendering only targets declared in BUILD files, only file-level targets, or all targets
     * https://www.pantsbuild.org/v2.32/docs/reference-filter#granularity
     */
    granularity?: 'all' | 'file' | 'BUILD';
    /**
     * Output the goal's stdout to this file
     * https://www.pantsbuild.org/v2.32/docs/reference-filter#output_file
     */
    output_file?: string;
    /**
     * String to use to separate lines in line-oriented output
     * https://www.pantsbuild.org/v2.32/docs/reference-filter#sep
     */
    sep?: string;
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-filter#tag_regex
     */
    tag_regex?: unknown[];
    /**
     * Filter targets based each targets's target type, e.g. `resources` or `python_sources`
     * https://www.pantsbuild.org/v2.32/docs/reference-filter#target_type
     */
    target_type?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  fix?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-fix#batch_size
     */
    batch_size?: number;
    /**
     * Only run these fixers and skip all others
     * https://www.pantsbuild.org/v2.32/docs/reference-fix#only
     */
    only?: unknown[];
    /**
     * If true, skip running all formatters
     * https://www.pantsbuild.org/v2.32/docs/reference-fix#skip_formatters
     */
  ...
  flake8?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-flake8#args
     */
    args?: unknown[];
    /**
     * Path to an INI config file understood by Flake8 (https://flake8.pycqa.org/en/latest/user/configuration.html)
     * https://www.pantsbuild.org/v2.32/docs/reference-flake8#config
     */
    config?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-flake8#config_discovery
     */
    config_discovery?: boolean;
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-flake8#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-flake8#entry_point
     */
    entry_point?: string;
    /**
     * Paths to extra files to include in the sandbox
     * https://www.pantsbuild.org/v2.32/docs/reference-flake8#extra_files
     */
    extra_files?: unknown[];
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-flake8#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-flake8#requirements
     */
    requirements?: unknown[];
    /**
     * If true, don't use Flake8 when running `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-flake8#skip
     */
    skip?: boolean;
    /**
     * An optional list of `python_sources` target addresses to load first-party plugins
     * https://www.pantsbuild.org/v2.32/docs/reference-flake8#source_plugins
     */
  ...
  fmt?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-fmt#batch_size
     */
    batch_size?: number;
    /**
     * Only run these formatters and skip all others
     * https://www.pantsbuild.org/v2.32/docs/reference-fmt#only
     */
    only?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  'generate-lockfiles'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-generate-lockfiles#custom_command
     */
    custom_command?: string;
    /**
     * Print a summary of changed distributions after generating the lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-generate-lockfiles#diff
     */
    diff?: boolean;
    /**
     * Include unchanged distributions in the diff summary output
     * https://www.pantsbuild.org/v2.32/docs/reference-generate-lockfiles#diff_include_unchanged
     */
    diff_include_unchanged?: boolean;
    /**
     * Only generate lockfiles for the specified resolve(s)
     * https://www.pantsbuild.org/v2.32/docs/reference-generate-lockfiles#resolve
     */
    resolve?: unknown[];
    /**
     * Attempt a minimal update of the lockfile, preserving existing dependency versions wherever possible
     * https://www.pantsbuild.org/v2.32/docs/reference-generate-lockfiles#sync
     */
    sync?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  'go-generate'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-go-generate#env_vars
     */
    env_vars?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  'go-test'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-go-test#coverage_html
     */
    coverage_html?: boolean;
    /**
     * Path to write the Go coverage reports to
     * https://www.pantsbuild.org/v2.32/docs/reference-go-test#coverage_output_dir
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-go-test#coverage_packages
     */
    coverage_packages?: unknown[];
    /**
     * Capture a CPU profile from the execution of the test runner
     * https://www.pantsbuild.org/v2.32/docs/reference-go-test#cpu_profile
     */
    cpu_profile?: boolean;
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-go-test#force_asan
     */
    force_asan?: boolean;
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-go-test#force_msan
     */
    force_msan?: boolean;
    /**
  ...
  gofmt?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-gofmt#args
     */
    args?: unknown[];
    /**
     * If true, don't use gofmt when running `pants fmt` and `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-gofmt#skip
     */
    skip?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  golang?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-golang#asdf_bin_relpath
     */
  ...
  'google-java-format'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-google-java-format#aosp
     */
    aosp?: boolean;
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-google-java-format#artifacts
     */
    artifacts?: unknown[];
    /**
     * List of JVM options to pass to `google-java-format` JVM processes
     * https://www.pantsbuild.org/v2.32/docs/reference-google-java-format#jvm_options
     */
    jvm_options?: unknown[];
    /**
     * Path to a lockfile used for installing the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-google-java-format#lockfile
     */
    lockfile?: string;
    /**
     * If true, don't use Google Java Format when running `pants fmt` and `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-google-java-format#skip
     */
    skip?: boolean;
    /**
     * Version string for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-google-java-format#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  graphql?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-graphql#open_graphiql
     */
  ...
  hadolint?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-hadolint#args
     */
    args?: unknown[];
    /**
     * Path to an YAML config file understood by Hadolint (https://github.com/hadolint/hadolint#configure)
     * https://www.pantsbuild.org/v2.32/docs/reference-hadolint#config
     */
    config?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-hadolint#config_discovery
     */
    config_discovery?: boolean;
    /**
     * Known versions to verify downloads against
     * https://www.pantsbuild.org/v2.32/docs/reference-hadolint#known_versions
     */
    known_versions?: unknown[];
    /**
     * If true, don't use Hadolint when running `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-hadolint#skip
     */
    skip?: boolean;
    /**
     * A dictionary mapping platforms to strings to be used when generating the URL to download the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-hadolint#url_platform_mapping
     */
    url_platform_mapping?: {
      [k: string]: unknown | undefined;
    };
    /**
     * URL to download the tool, either as a single binary file or a compressed file (e.g. zip file)
     * https://www.pantsbuild.org/v2.32/docs/reference-hadolint#url_template
     */
    url_template?: string;
    /**
     * What action to take in case the requested version of Hadolint is not supported
     * https://www.pantsbuild.org/v2.32/docs/reference-hadolint#use_unsupported_version
     */
    use_unsupported_version?: 'error' | 'warning';
    /**
     * Use this version of Hadolint
     * https://www.pantsbuild.org/v2.32/docs/reference-hadolint#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  ipython?: {
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-ipython#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-ipython#entry_point
     */
    entry_point?: string;
    /**
     * Whether to tell IPython not to put the CWD on the import path
     * https://www.pantsbuild.org/v2.32/docs/reference-ipython#ignore_cwd
     */
    ignore_cwd?: boolean;
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-ipython#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-ipython#requirements
     */
    requirements?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  jar_tool?: {
    /**
     * Artifact requirements for this tool using specified as either the address of a `jvm_artifact` target or, alternatively, as a colon-separated Maven coordinates (e.g., `group:name:version`)
     * https://www.pantsbuild.org/v2.32/docs/reference-jar_tool#artifacts
     */
    artifacts?: unknown[];
    /**
     * List of JVM options to pass to `jar_tool` JVM processes
     * https://www.pantsbuild.org/v2.32/docs/reference-jar_tool#jvm_options
     */
    jvm_options?: unknown[];
    /**
     * Path to a lockfile used for installing the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-jar_tool#lockfile
     */
    lockfile?: string;
    /**
     * Version string for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-jar_tool#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  jarjar?: {
    /**
     * Artifact requirements for this tool using specified as either the address of a `jvm_artifact` target or, alternatively, as a colon-separated Maven coordinates (e.g., `group:name:version`)
     * https://www.pantsbuild.org/v2.32/docs/reference-jarjar#artifacts
     */
    artifacts?: unknown[];
    /**
     * List of JVM options to pass to `jarjar` JVM processes
     * https://www.pantsbuild.org/v2.32/docs/reference-jarjar#jvm_options
     */
    jvm_options?: unknown[];
    /**
     * Path to a lockfile used for installing the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-jarjar#lockfile
     */
    lockfile?: string;
    /**
     * The strategy to use when processing class files that are in the wrong package
     * https://www.pantsbuild.org/v2.32/docs/reference-jarjar#misplaced_class_strategy
     */
    misplaced_class_strategy?: 'fatal' | 'skip' | 'omit' | 'move';
    /**
     * Skip the processing of the JAR manifest
     * https://www.pantsbuild.org/v2.32/docs/reference-jarjar#skip_manifest
     */
    skip_manifest?: boolean;
    /**
     * Version string for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-jarjar#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  'java-infer'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-java-infer#consumed_types
     */
    consumed_types?: boolean;
    /**
     * Infer a target's dependencies by parsing import statements from sources
     * https://www.pantsbuild.org/v2.32/docs/reference-java-infer#imports
     */
    imports?: boolean;
    /**
     * A dictionary mapping a Java package path to a JVM artifact coordinate (GROUP:ARTIFACT) without the version
     * https://www.pantsbuild.org/v2.32/docs/reference-java-infer#third_party_import_mapping
     */
  ...
  'java-parser'?: {
    /**
     * Artifact requirements for this tool using specified as either the address of a `jvm_artifact` target or, alternatively, as a colon-separated Maven coordinates (e.g., `group:name:version`)
     * https://www.pantsbuild.org/v2.32/docs/reference-java-parser#artifacts
     */
    artifacts?: unknown[];
    /**
     * List of JVM options to pass to `java-parser` JVM processes
     * https://www.pantsbuild.org/v2.32/docs/reference-java-parser#jvm_options
     */
    jvm_options?: unknown[];
    /**
     * Path to a lockfile used for installing the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-java-parser#lockfile
     */
    lockfile?: string;
    /**
     * Version string for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-java-parser#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  javac?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-javac#args
     */
    args?: unknown[];
    /**
     * If true, add `java_sources` and `java_tests` targets with the `tailor` goal
     * https://www.pantsbuild.org/v2.32/docs/reference-javac#tailor_source_targets
     */
  ...
  junit?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-junit#args
     */
    args?: unknown[];
    /**
     * Artifact requirements for this tool using specified as either the address of a `jvm_artifact` target or, alternatively, as a colon-separated Maven coordinates (e.g., `group:name:version`)
     * https://www.pantsbuild.org/v2.32/docs/reference-junit#artifacts
     */
    artifacts?: unknown[];
    /**
     * List of JVM options to pass to `junit` JVM processes
     * https://www.pantsbuild.org/v2.32/docs/reference-junit#jvm_options
     */
    jvm_options?: unknown[];
    /**
     * Path to a lockfile used for installing the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-junit#lockfile
     */
    lockfile?: string;
    /**
     * If true, don't use JUnit when running `pants test`
     * https://www.pantsbuild.org/v2.32/docs/reference-junit#skip
     */
    skip?: boolean;
    /**
     * Version string for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-junit#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  jvm?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-jvm#tool_jdk
     */
    tool_jdk?: string;
    [k: string]: unknown | undefined;
  };
  ...
  lint?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-lint#batch_size
     */
    batch_size?: number;
    /**
     * Only run these linters and skip all others
     * https://www.pantsbuild.org/v2.32/docs/reference-lint#only
     */
    only?: unknown[];
    /**
     * If true, skip running all fixers in check-only mode
     * https://www.pantsbuild.org/v2.32/docs/reference-lint#skip_fixers
     */
    skip_fixers?: boolean;
    /**
     * If true, skip running all formatters in check-only mode
     * https://www.pantsbuild.org/v2.32/docs/reference-lint#skip_formatters
     */
    skip_formatters?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  list?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-list#documented
     */
    documented?: boolean;
    /**
     * Output the goal's stdout to this file
     * https://www.pantsbuild.org/v2.32/docs/reference-list#output_file
     */
    output_file?: string;
    /**
     * String to use to separate lines in line-oriented output
     * https://www.pantsbuild.org/v2.32/docs/reference-list#sep
     */
    sep?: string;
    [k: string]: unknown | undefined;
  };
  ...
  mypy?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-mypy#args
     */
    args?: unknown[];
    /**
     * `sqlite`: Default
     * https://www.pantsbuild.org/v2.32/docs/reference-mypy#cache_mode
     */
    cache_mode?: 'sqlite' | 'none';
    /**
     * Path to a config file understood by MyPy (https://mypy.readthedocs.io/en/stable/config_file.html)
     * https://www.pantsbuild.org/v2.32/docs/reference-mypy#config
     */
    config?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-mypy#config_discovery
     */
    config_discovery?: boolean;
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-mypy#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-mypy#entry_point
     */
    entry_point?: string;
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-mypy#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * Python interpreter constraints for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-mypy#interpreter_constraints
     */
    interpreter_constraints?: unknown[];
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-mypy#requirements
     */
    requirements?: unknown[];
    /**
     * If true, don't use MyPy when running `pants check`
     * https://www.pantsbuild.org/v2.32/docs/reference-mypy#skip
     */
    skip?: boolean;
    /**
     * An optional list of `python_sources` target addresses to load first-party plugins
     * https://www.pantsbuild.org/v2.32/docs/reference-mypy#source_plugins
     */
    source_plugins?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  nodejs?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#corepack_env_vars
     */
    corepack_env_vars?: unknown[];
    /**
     * The PATH value that will be used to find any tools required to run nodejs processes
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#executable_search_paths
     */
    executable_search_paths?: unknown[];
    /**
     * Environment variables to set during package manager operations
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#extra_env_vars
     */
    extra_env_vars?: unknown[];
    /**
     * Known versions to verify downloads against
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#known_versions
     */
    known_versions?: unknown[];
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#optional_tools
     */
    optional_tools?: unknown[];
    /**
     * Default Node.js package manager to use
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#package_manager
     */
    package_manager?: string;
    /**
     * A mapping of package manager versions to semver releases
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#package_managers
     */
    package_managers?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#resolves
     */
    resolves?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#search_path
     */
    search_path?: unknown[];
    /**
     * List any additional executable tools required for node processes to work
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#tools
     */
    tools?: unknown[];
    /**
     * A dictionary mapping platforms to strings to be used when generating the URL to download the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#url_platform_mapping
     */
    url_platform_mapping?: {
      [k: string]: unknown | undefined;
    };
    /**
     * URL to download the tool, either as a single binary file or a compressed file (e.g. zip file)
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#url_template
     */
    url_template?: string;
    /**
     * Use this version of nodejs
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  'nodejs-infer'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs-infer#imports
     */
    imports?: boolean;
    /**
     * Infer a `package_json`'s dependencies by parsing entry point statements from the package.json file
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs-infer#package_json_entry_points
     */
    package_json_entry_points?: boolean;
    /**
     * How to handle imports that don't have an inferable owner
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs-infer#unowned_dependency_behavior
     */
  ...
  'nodejs-test'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs-test#coverage_output_dir
     */
    coverage_output_dir?: string;
    /**
     * If true, don't use Node.js tests when running `pants test`
     * https://www.pantsbuild.org/v2.32/docs/reference-nodejs-test#skip
     */
    skip?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  paths?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-paths#from
     */
    from?: string;
    /**
     * Output the goal's stdout to this file
     * https://www.pantsbuild.org/v2.32/docs/reference-paths#output_file
     */
    output_file?: string;
    /**
     * The path end address
     * https://www.pantsbuild.org/v2.32/docs/reference-paths#to
     */
    to?: string;
    [k: string]: unknown | undefined;
  };
  ...
  peek?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-peek#exclude_defaults
     */
    exclude_defaults?: boolean;
    /**
     * Whether to include additional information generated by plugins
     * https://www.pantsbuild.org/v2.32/docs/reference-peek#include_additional_info
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-peek#include_dep_rules
     */
    include_dep_rules?: boolean;
    /**
     * Output the goal's stdout to this file
     * https://www.pantsbuild.org/v2.32/docs/reference-peek#output_file
     */
    output_file?: string;
    [k: string]: unknown | undefined;
  };
  ...
  'pex-binary-defaults'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-pex-binary-defaults#emit_warnings
     */
    emit_warnings?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  'pex-cli'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-pex-cli#global_args
     */
    global_args?: unknown[];
    /**
     * Known versions to verify downloads against
     * https://www.pantsbuild.org/v2.32/docs/reference-pex-cli#known_versions
     */
    known_versions?: unknown[];
    /**
     * A dictionary mapping platforms to strings to be used when generating the URL to download the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-pex-cli#url_platform_mapping
     */
    url_platform_mapping?: {
      [k: string]: unknown | undefined;
    };
    /**
     * URL to download the tool, either as a single binary file or a compressed file (e.g. zip file)
     * https://www.pantsbuild.org/v2.32/docs/reference-pex-cli#url_template
     */
    url_template?: string;
    /**
     * What action to take in case the requested version of pex is not supported
     * https://www.pantsbuild.org/v2.32/docs/reference-pex-cli#use_unsupported_version
     */
    use_unsupported_version?: 'error' | 'warning';
    /**
     * Use this version of pex
     * https://www.pantsbuild.org/v2.32/docs/reference-pex-cli#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  preamble?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-preamble#skip
     */
    skip?: boolean;
    /**
     * Which preamble template to use based on the path globs (relative to the build root)
     * https://www.pantsbuild.org/v2.32/docs/reference-preamble#template_by_globs
     */
    template_by_globs?:
      | {
          [k: string]: unknown | undefined;
  ...
  prettier?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-prettier#args
     */
    args?: unknown[];
    /**
     * Override the binary to run for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-prettier#binary_name
     */
    binary_name?: string;
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-prettier#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * If true, don't use Prettier when running `pants fmt` and `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-prettier#skip
     */
    skip?: boolean;
    /**
     * Version string for the tool in the form package@version (e.g. prettier@3.6.2)
     * https://www.pantsbuild.org/v2.32/docs/reference-prettier#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  publish?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-publish#noninteractive_process_output
     */
    noninteractive_process_output?: 'all' | 'failed' | 'none';
    /**
     * Filename for JSON structured publish information
     * https://www.pantsbuild.org/v2.32/docs/reference-publish#output
     */
    output?: string;
    [k: string]: unknown | undefined;
  };
  ...
  'py-constraints'?: {
    /**
     * Output the goal's stdout to this file
     * https://www.pantsbuild.org/v2.32/docs/reference-py-constraints#output_file
     */
    output_file?: string;
    /**
     * Output a CSV summary of interpreter constraints for your whole repository
     * https://www.pantsbuild.org/v2.32/docs/reference-py-constraints#summary
     */
    summary?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  pyoxidizer?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-pyoxidizer#args
     */
    args?: unknown[];
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-pyoxidizer#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-pyoxidizer#entry_point
     */
    entry_point?: string;
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-pyoxidizer#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * Python interpreter constraints for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-pyoxidizer#interpreter_constraints
     */
    interpreter_constraints?: unknown[];
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-pyoxidizer#requirements
     */
    requirements?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  pytest?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-pytest#allow_empty_test_collection
     */
    allow_empty_test_collection?: boolean;
    /**
     * Arguments to pass directly to Pytest, e.g. `--pytest-args='-k test_foo --quiet'`
     * https://www.pantsbuild.org/v2.32/docs/reference-pytest#args
     */
    args?: unknown[];
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-pytest#config
     */
    config?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-pytest#config_discovery
     */
    config_discovery?: boolean;
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-pytest#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-pytest#entry_point
     */
    entry_point?: string;
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-pytest#execution_slot_var
     */
    execution_slot_var?: string;
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-pytest#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * The format of generated junit XML files
     * https://www.pantsbuild.org/v2.32/docs/reference-pytest#junit_family
     */
    junit_family?: string;
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-pytest#requirements
     */
    requirements?: unknown[];
    /**
     * If true, don't use Pytest when running `pants test`
     * https://www.pantsbuild.org/v2.32/docs/reference-pytest#skip
     */
    skip?: boolean;
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-pytest#xdist_enabled
     */
  ...
  python?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#default_resolve
     */
    default_resolve?: string;
    /**
     * The default value used for the `run_goal_use_sandbox` field of Python targets
     * https://www.pantsbuild.org/v2.32/docs/reference-python#default_run_goal_use_sandbox
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#default_to_resolve_interpreter_constraints
     */
    default_to_resolve_interpreter_constraints?: boolean;
    /**
     * Create targets for all Python lockfiles defined in `[python].resolves`
     * https://www.pantsbuild.org/v2.32/docs/reference-python#enable_lockfile_targets
     */
    enable_lockfile_targets?: boolean;
    /**
     * Set to true to enable lockfiles for user code
     * https://www.pantsbuild.org/v2.32/docs/reference-python#enable_resolves
     */
    enable_resolves?: boolean;
    /**
     * The Python interpreters your codebase is compatible with
     * https://www.pantsbuild.org/v2.32/docs/reference-python#interpreter_constraints
     */
    interpreter_constraints?: unknown[];
    /**
     * All known Python major/minor interpreter versions that may be used by either your code or tools used by your code
     * https://www.pantsbuild.org/v2.32/docs/reference-python#interpreter_versions_universe
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#invalid_lockfile_behavior
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#resolves_generate_lockfiles
     */
    resolves_generate_lockfiles?: boolean;
    /**
     * The platforms the built PEX should be compatible with when generating lockfiles
     * https://www.pantsbuild.org/v2.32/docs/reference-python#resolves_to_complete_platforms
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#resolves_to_constraints_file
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#resolves_to_excludes
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#resolves_to_interpreter_constraints
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#resolves_to_lock_style
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#resolves_to_no_binary
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#resolves_to_only_binary
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#resolves_to_overrides
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#resolves_to_sources
     */
    resolves_to_sources?: {
      [k: string]: unknown | undefined;
    };
    /**
     * Filter packages by upload time when generating lockfiles, only considering packages that were uploaded before the specified datetime
     * https://www.pantsbuild.org/v2.32/docs/reference-python#resolves_to_uploaded_prior_to
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#run_against_entire_lockfile
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#separate_lockfile_metadata_file
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#tailor_ignore_empty_init_files
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#tailor_pex_binary_targets
     */
    tailor_pex_binary_targets?: boolean;
    /**
     * If true, add `resource` targets for marker files named `py.typed` with the `tailor` goal
     * https://www.pantsbuild.org/v2.32/docs/reference-python#tailor_py_typed_targets
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#tailor_requirements_targets
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python#tailor_source_targets
     */
    tailor_source_targets?: boolean;
    /**
     * Globs to match your test files
     * https://www.pantsbuild.org/v2.32/docs/reference-python#tailor_test_file_globs
     */
    tailor_test_file_globs?: unknown[];
    /**
     * Globs to match your testutil files
     * https://www.pantsbuild.org/v2.32/docs/reference-python#tailor_testutils_file_globs
     */
    tailor_testutils_file_globs?: unknown[];
    /**
     * True if Pants should generate a deprecation warning when Python 2.x is used in interpreter constraints
     * https://www.pantsbuild.org/v2.32/docs/reference-python#warn_on_python2_usage
     */
  ...
  'python-bootstrap'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-bootstrap#internal_python_build_standalone_info
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-bootstrap#names
     */
    names?: unknown[];
    /**
     * A list of paths to search for Python interpreters
     * https://www.pantsbuild.org/v2.32/docs/reference-python-bootstrap#search_path
     */
    search_path?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  'python-dump-source-analysis'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-dump-source-analysis#analysis_flavor
     */
  ...
  'python-infer'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#ambiguity_resolution
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#assets
     */
    assets?: boolean;
    /**
     * If `--assets` is True, treat valid-looking strings with at least this many forward slash characters as potential assets
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#assets_min_slashes
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#conftests
     */
    conftests?: boolean;
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#entry_points
     */
    entry_points?: boolean;
    /**
     * Unowned imports that should be ignored
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#ignored_unowned_imports
     */
    ignored_unowned_imports?: unknown[];
    /**
     * Infer a target's imported dependencies by parsing import statements from sources
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#imports
     */
    imports?: boolean;
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#init_files
     */
    init_files?: 'always' | 'content_only' | 'never';
    /**
     * Dotted string values that should be ignored for string-based dependency inference
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#string_import_ignore
     */
    string_import_ignore?: unknown[];
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#string_imports
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#string_imports_min_dots
     */
    string_imports_min_dots?: number;
    /**
     * How to handle imports that don't have an inferable owner
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#unowned_dependency_behavior
     */
    unowned_dependency_behavior?: 'error' | 'warning' | 'ignore';
    /**
     * Use the new Rust-based, multithreaded, in-process dependency parser
     * https://www.pantsbuild.org/v2.32/docs/reference-python-infer#use_rust_parser
     */
    use_rust_parser?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  'python-native-code'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-native-code#cpp_flags
     */
    cpp_flags?: unknown[];
    /**
     * Override the `LDFLAGS` environment variable for any forked subprocesses
     * https://www.pantsbuild.org/v2.32/docs/reference-python-native-code#ld_flags
     */
    ld_flags?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  'python-repos'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-repos#find_links
     */
    find_links?: unknown[];
    /**
     * URLs of [PEP-503 compatible](https://peps.python.org/pep-0503/) code repository indexes to look for requirements
     * https://www.pantsbuild.org/v2.32/docs/reference-python-repos#indexes
     */
    indexes?: unknown[];
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-python-repos#path_mappings
     */
  ...
  'regex-lint'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-regex-lint#config
     */
    config?:
      | {
          [k: string]: unknown | undefined;
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-regex-lint#detail_level
     */
    detail_level?: 'none' | 'summary' | 'nonmatching' | 'names' | 'all';
    /**
     * If true, don't use regex-lint when running `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-regex-lint#skip
     */
    skip?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  repl?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-repl#args
     */
    args?: unknown[];
    /**
     * True if the REPL should be restarted if its inputs have changed
     * https://www.pantsbuild.org/v2.32/docs/reference-repl#restartable
     */
    restartable?: boolean;
    /**
     * Override the automatically-detected REPL program for the target(s) specified
     * https://www.pantsbuild.org/v2.32/docs/reference-repl#shell
     */
    shell?: string;
    [k: string]: unknown | undefined;
  };
  ...
  roots?: {
    /**
     * Output the goal's stdout to this file
     * https://www.pantsbuild.org/v2.32/docs/reference-roots#output_file
     */
    output_file?: string;
    /**
     * String to use to separate lines in line-oriented output
     * https://www.pantsbuild.org/v2.32/docs/reference-roots#sep
     */
    sep?: string;
    [k: string]: unknown | undefined;
  };
  ...
  ruff?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-ruff#config_discovery
     */
    config_discovery?: boolean;
    /**
     * Known versions to verify downloads against
     * https://www.pantsbuild.org/v2.32/docs/reference-ruff#known_versions
     */
    known_versions?: unknown[];
    /**
     * If true, don't use Ruff when running `pants fmt` and `pants fix` and `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-ruff#skip
     */
    skip?: boolean;
    /**
     * A dictionary mapping platforms to strings to be used when generating the URL to download the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-ruff#url_platform_mapping
     */
    url_platform_mapping?: {
      [k: string]: unknown | undefined;
    };
    /**
     * URL to download the tool, either as a single binary file or a compressed file (e.g. zip file)
     * https://www.pantsbuild.org/v2.32/docs/reference-ruff#url_template
     */
    url_template?: string;
    /**
     * What action to take in case the requested version of Ruff is not supported
     * https://www.pantsbuild.org/v2.32/docs/reference-ruff#use_unsupported_version
     */
    use_unsupported_version?: 'error' | 'warning';
    /**
     * Use this version of Ruff
     * https://www.pantsbuild.org/v2.32/docs/reference-ruff#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  run?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-run#args
     */
    args?: unknown[];
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-run#debug_adapter
     */
  ...
  scala?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-scala#tailor_source_targets
     */
    tailor_source_targets?: boolean;
    /**
     * A dictionary mapping the name of a resolve to the Scala version to use for all Scala targets consuming that resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-scala#version_for_resolve
     */
    version_for_resolve?: {
      [k: string]: unknown | undefined;
    };
  ...
  'scala-infer'?: {
    /**
     * Infer a target's dependencies by parsing consumed types from sources
     * https://www.pantsbuild.org/v2.32/docs/reference-scala-infer#consumed_types
     */
    consumed_types?: boolean;
    /**
     * If true, add a dependency on all `scala_source` targets generated by the same `scala_sources` target generator
     * https://www.pantsbuild.org/v2.32/docs/reference-scala-infer#force_add_siblings_as_dependencies
     */
    force_add_siblings_as_dependencies?: boolean;
    /**
     * Infer a target's dependencies by parsing import statements from sources
     * https://www.pantsbuild.org/v2.32/docs/reference-scala-infer#imports
     */
    imports?: boolean;
    /**
     * Add dependency on the package object to every target
     * https://www.pantsbuild.org/v2.32/docs/reference-scala-infer#package_objects
     */
  ...
  'scala-parser'?: {
    /**
     * Artifact requirements for this tool using specified as either the address of a `jvm_artifact` target or, alternatively, as a colon-separated Maven coordinates (e.g., `group:name:version`)
     * https://www.pantsbuild.org/v2.32/docs/reference-scala-parser#artifacts
     */
    artifacts?: unknown[];
    /**
     * List of JVM options to pass to `scala-parser` JVM processes
     * https://www.pantsbuild.org/v2.32/docs/reference-scala-parser#jvm_options
     */
    jvm_options?: unknown[];
    /**
     * Path to a lockfile used for installing the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-scala-parser#lockfile
     */
    lockfile?: string;
    /**
     * Version string for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-scala-parser#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  scalac?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-scalac#args
     */
    args?: unknown[];
    /**
     * A dictionary mapping JVM resolve names to additional arguments to pass to `scalac` for that resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-scalac#args_for_resolve
     */
    args_for_resolve?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-scalac#plugins_for_resolve
     */
    plugins_for_resolve?: {
      [k: string]: unknown | undefined;
    };
  ...
  scalafix?: {
    /**
     * Artifact requirements for this tool using specified as either the address of a `jvm_artifact` target or, alternatively, as a colon-separated Maven coordinates (e.g., `group:name:version`)
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafix#artifacts
     */
    artifacts?: unknown[];
    /**
     * Name of a config file understood by scalafix (https://scalacenter.github.io/scalafix/docs/users/configuration.html)
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafix#config_file_name
     */
    config_file_name?: string;
    /**
     * List of JVM options to pass to `scalafix` JVM processes
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafix#jvm_options
     */
    jvm_options?: unknown[];
    /**
     * Path to a lockfile used for installing the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafix#lockfile
     */
    lockfile?: string;
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafix#orphan_files_behavior
     */
    orphan_files_behavior?: 'ignore' | 'error' | 'warn';
    /**
     * List of targets providing additional Scalafix rules
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafix#rule_targets
     */
    rule_targets?: unknown[];
    /**
     * Whether semantic rules are enabled or not
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafix#semantic_rules
     */
    semantic_rules?: boolean;
    /**
     * If true, don't use scalafix when running `pants fix` and `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafix#skip
     */
    skip?: boolean;
    /**
     * Version string for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafix#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  scalafmt?: {
    /**
     * Artifact requirements for this tool using specified as either the address of a `jvm_artifact` target or, alternatively, as a colon-separated Maven coordinates (e.g., `group:name:version`)
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafmt#artifacts
     */
    artifacts?: unknown[];
    /**
     * Name of a config file understood by scalafmt (https://scalameta.org/scalafmt/docs/configuration.html)
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafmt#config_file_name
     */
    config_file_name?: string;
    /**
     * List of JVM options to pass to `scalafmt` JVM processes
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafmt#jvm_options
     */
    jvm_options?: unknown[];
    /**
     * Path to a lockfile used for installing the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafmt#lockfile
     */
    lockfile?: string;
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafmt#orphan_files_behavior
     */
    orphan_files_behavior?: 'ignore' | 'error' | 'warn';
    /**
     * If true, don't use scalafmt when running `pants fmt` and `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafmt#skip
     */
    skip?: boolean;
    /**
     * Version string for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-scalafmt#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  scalatest?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-scalatest#args
     */
    args?: unknown[];
    /**
     * Artifact requirements for this tool using specified as either the address of a `jvm_artifact` target or, alternatively, as a colon-separated Maven coordinates (e.g., `group:name:version`)
     * https://www.pantsbuild.org/v2.32/docs/reference-scalatest#artifacts
     */
    artifacts?: unknown[];
    /**
     * List of JVM options to pass to `scalatest` JVM processes
     * https://www.pantsbuild.org/v2.32/docs/reference-scalatest#jvm_options
     */
    jvm_options?: unknown[];
    /**
     * Path to a lockfile used for installing the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-scalatest#lockfile
     */
    lockfile?: string;
    /**
     * If true, don't use Scalatest when running `pants test`
     * https://www.pantsbuild.org/v2.32/docs/reference-scalatest#skip
     */
    skip?: boolean;
    /**
     * Version string for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-scalatest#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  scc?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-scc#args
     */
    args?: unknown[];
    /**
     * Known versions to verify downloads against
     * https://www.pantsbuild.org/v2.32/docs/reference-scc#known_versions
     */
    known_versions?: unknown[];
    /**
     * A dictionary mapping platforms to strings to be used when generating the URL to download the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-scc#url_platform_mapping
     */
    url_platform_mapping?: {
      [k: string]: unknown | undefined;
    };
    /**
     * URL to download the tool, either as a single binary file or a compressed file (e.g. zip file)
     * https://www.pantsbuild.org/v2.32/docs/reference-scc#url_template
     */
    url_template?: string;
    /**
     * What action to take in case the requested version of SCC is not supported
     * https://www.pantsbuild.org/v2.32/docs/reference-scc#use_unsupported_version
     */
    use_unsupported_version?: 'error' | 'warning';
    /**
     * Use this version of SCC
     * https://www.pantsbuild.org/v2.32/docs/reference-scc#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  'setup-py-generation'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-setup-py-generation#first_party_dependency_version_scheme
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-setup-py-generation#generate_setup_default
     */
  ...
  setuptools?: {
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-setuptools#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-setuptools#requirements
     */
    requirements?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  'setuptools-scm'?: {
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-setuptools-scm#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-setuptools-scm#entry_point
     */
    entry_point?: string;
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-setuptools-scm#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * Python interpreter constraints for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-setuptools-scm#interpreter_constraints
     */
    interpreter_constraints?: unknown[];
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-setuptools-scm#requirements
     */
    requirements?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  'shell-setup'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-shell-setup#dependency_inference
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-shell-setup#executable_search_paths
     */
    executable_search_paths?: unknown[];
    /**
     * If true, add `shunit2_tests` targets with the `tailor` goal
     * https://www.pantsbuild.org/v2.32/docs/reference-shell-setup#tailor_shunit2_tests
     */
    tailor_shunit2_tests?: boolean;
    /**
     * If true, add `shell_sources` targets with the `tailor` goal
     * https://www.pantsbuild.org/v2.32/docs/reference-shell-setup#tailor_sources
     */
  ...
  'shell-test'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-shell-test#skip
     */
    skip?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  shellcheck?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-shellcheck#args
     */
    args?: unknown[];
    /**
     * If true, Pants will include all relevant `.shellcheckrc` and `shellcheckrc` files during runs
     * https://www.pantsbuild.org/v2.32/docs/reference-shellcheck#config_discovery
     */
    config_discovery?: boolean;
    /**
     * Known versions to verify downloads against
     * https://www.pantsbuild.org/v2.32/docs/reference-shellcheck#known_versions
     */
    known_versions?: unknown[];
    /**
     * If true, don't use Shellcheck when running `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-shellcheck#skip
     */
    skip?: boolean;
    /**
     * A dictionary mapping platforms to strings to be used when generating the URL to download the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-shellcheck#url_platform_mapping
     */
    url_platform_mapping?: {
      [k: string]: unknown | undefined;
    };
    /**
     * URL to download the tool, either as a single binary file or a compressed file (e.g. zip file)
     * https://www.pantsbuild.org/v2.32/docs/reference-shellcheck#url_template
     */
    url_template?: string;
    /**
     * What action to take in case the requested version of Shellcheck is not supported
     * https://www.pantsbuild.org/v2.32/docs/reference-shellcheck#use_unsupported_version
     */
    use_unsupported_version?: 'error' | 'warning';
    /**
     * Use this version of Shellcheck
     * https://www.pantsbuild.org/v2.32/docs/reference-shellcheck#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  shfmt?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-shfmt#args
     */
    args?: unknown[];
    /**
     * If true, Pants will include all relevant `.editorconfig` files during runs
     * https://www.pantsbuild.org/v2.32/docs/reference-shfmt#config_discovery
     */
    config_discovery?: boolean;
    /**
     * Known versions to verify downloads against
     * https://www.pantsbuild.org/v2.32/docs/reference-shfmt#known_versions
     */
    known_versions?: unknown[];
    /**
     * If true, don't use shfmt when running `pants fmt` and `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-shfmt#skip
     */
    skip?: boolean;
    /**
     * A dictionary mapping platforms to strings to be used when generating the URL to download the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-shfmt#url_platform_mapping
     */
    url_platform_mapping?: {
      [k: string]: unknown | undefined;
    };
    /**
     * URL to download the tool, either as a single binary file or a compressed file (e.g. zip file)
     * https://www.pantsbuild.org/v2.32/docs/reference-shfmt#url_template
     */
    url_template?: string;
    /**
     * What action to take in case the requested version of shfmt is not supported
     * https://www.pantsbuild.org/v2.32/docs/reference-shfmt#use_unsupported_version
     */
    use_unsupported_version?: 'error' | 'warning';
    /**
     * Use this version of shfmt
     * https://www.pantsbuild.org/v2.32/docs/reference-shfmt#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  shunit2?: {
    /**
     * Known versions to verify downloads against
     * https://www.pantsbuild.org/v2.32/docs/reference-shunit2#known_versions
     */
    known_versions?: unknown[];
    /**
     * If true, don't use shunit2 when running `pants test`
     * https://www.pantsbuild.org/v2.32/docs/reference-shunit2#skip
     */
    skip?: boolean;
    /**
     * A dictionary mapping platforms to strings to be used when generating the URL to download the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-shunit2#url_platform_mapping
     */
    url_platform_mapping?: {
      [k: string]: unknown | undefined;
    };
    /**
     * URL to download the tool, either as a single binary file or a compressed file (e.g. zip file)
     * https://www.pantsbuild.org/v2.32/docs/reference-shunit2#url_template
     */
    url_template?: string;
    /**
     * What action to take in case the requested version of shunit2 is not supported
     * https://www.pantsbuild.org/v2.32/docs/reference-shunit2#use_unsupported_version
     */
    use_unsupported_version?: 'error' | 'warning';
    /**
     * Use this version of shunit2
     * https://www.pantsbuild.org/v2.32/docs/reference-shunit2#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  source?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-source#marker_filenames
     */
    marker_filenames?: unknown[];
    /**
     * A list of source root suffixes
     * https://www.pantsbuild.org/v2.32/docs/reference-source#root_patterns
     */
  ...
  stats?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-stats#format
     */
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-stats#log
     */
    log?: boolean;
    /**
     * At the end of the Pants run, report a summary of memory usage
     * https://www.pantsbuild.org/v2.32/docs/reference-stats#memory_summary
     */
    memory_summary?: boolean;
    /**
     * Output the stats to this file
     * https://www.pantsbuild.org/v2.32/docs/reference-stats#output_file
     */
    output_file?: string;
    [k: string]: unknown | undefined;
  };
  ...
  'strip-jar'?: {
    /**
     * Artifact requirements for this tool using specified as either the address of a `jvm_artifact` target or, alternatively, as a colon-separated Maven coordinates (e.g., `group:name:version`)
     * https://www.pantsbuild.org/v2.32/docs/reference-strip-jar#artifacts
     */
    artifacts?: unknown[];
    /**
     * List of JVM options to pass to `strip-jar` JVM processes
     * https://www.pantsbuild.org/v2.32/docs/reference-strip-jar#jvm_options
     */
    jvm_options?: unknown[];
    /**
     * Path to a lockfile used for installing the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-strip-jar#lockfile
     */
    lockfile?: string;
    /**
     * Version string for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-strip-jar#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  'subprocess-environment'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-subprocess-environment#env_vars
     */
    env_vars?: unknown[];
    [k: string]: unknown | undefined;
  };
  ...
  'system-binaries'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-system-binaries#system_binary_paths
     */
  ...
  tailor?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-tailor#alias_mapping
     */
    alias_mapping?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-tailor#build_file_header
     */
    build_file_header?: string;
    /**
     * The indent to use when auto-editing BUILD files
     * https://www.pantsbuild.org/v2.32/docs/reference-tailor#build_file_indent
     */
    build_file_indent?: string;
    /**
     * The name to use for generated BUILD files
     * https://www.pantsbuild.org/v2.32/docs/reference-tailor#build_file_name
     */
    build_file_name?: string;
    /**
     * Do not write changes to disk, only write back what would change
     * https://www.pantsbuild.org/v2.32/docs/reference-tailor#check
     */
    check?: boolean;
    /**
     * Do not add these target definitions
     * https://www.pantsbuild.org/v2.32/docs/reference-tailor#ignore_adding_targets
     */
    ignore_adding_targets?: unknown[];
    /**
     * Do not edit or create BUILD files at these paths
     * https://www.pantsbuild.org/v2.32/docs/reference-tailor#ignore_paths
     */
  ...
  taplo?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-taplo#args
     */
    args?: unknown[];
    /**
     * If true, Pants will include a `taplo.toml` or `.taplo.toml` file found in the build root during a run
     * https://www.pantsbuild.org/v2.32/docs/reference-taplo#config_discovery
     */
    config_discovery?: boolean;
    /**
     * A list of glob patterns of files to include/exclude in formatting relative to the build root
     * https://www.pantsbuild.org/v2.32/docs/reference-taplo#glob_pattern
     */
    glob_pattern?: unknown[];
    /**
     * Known versions to verify downloads against
     * https://www.pantsbuild.org/v2.32/docs/reference-taplo#known_versions
     */
    known_versions?: unknown[];
    /**
     * If true, don't use Taplo when running `pants fmt` and `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-taplo#skip
     */
    skip?: boolean;
    /**
     * A dictionary mapping platforms to strings to be used when generating the URL to download the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-taplo#url_platform_mapping
     */
    url_platform_mapping?: {
      [k: string]: unknown | undefined;
    };
    /**
     * URL to download the tool, either as a single binary file or a compressed file (e.g. zip file)
     * https://www.pantsbuild.org/v2.32/docs/reference-taplo#url_template
     */
    url_template?: string;
    /**
     * What action to take in case the requested version of Taplo is not supported
     * https://www.pantsbuild.org/v2.32/docs/reference-taplo#use_unsupported_version
     */
    use_unsupported_version?: 'error' | 'warning';
    /**
     * Use this version of Taplo
     * https://www.pantsbuild.org/v2.32/docs/reference-taplo#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  test?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-test#attempts_default
     */
    attempts_default?: number;
    /**
     * The target maximum number of files to be included in each run of batch-enabled test runners
     * https://www.pantsbuild.org/v2.32/docs/reference-test#batch_size
     */
    batch_size?: number;
    /**
     * Run tests sequentially in an interactive process
     * https://www.pantsbuild.org/v2.32/docs/reference-test#debug
     */
    debug?: boolean;
    /**
  ...
  twine?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-twine#args
     */
    args?: unknown[];
    /**
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-twine#ca_certs_path
     */
    ca_certs_path?: string;
    /**
     * Path to a .pypirc config file to use. (https://packaging.python.org/specifications/pypirc/)
     * https://www.pantsbuild.org/v2.32/docs/reference-twine#config
     */
    config?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-twine#config_discovery
     */
    config_discovery?: boolean;
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-twine#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-twine#entry_point
     */
    entry_point?: string;
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-twine#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * Python interpreter constraints for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-twine#interpreter_constraints
     */
    interpreter_constraints?: unknown[];
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-twine#requirements
     */
    requirements?: unknown[];
    /**
     * If true, don't use Twine when running `pants publish`
     * https://www.pantsbuild.org/v2.32/docs/reference-twine#skip
     */
    skip?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  typescript?: {
    /**
     * Override the binary to run for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-typescript#binary_name
     */
    binary_name?: string;
    /**
     * Extra arguments to pass to tsc when running in --build mode
     * https://www.pantsbuild.org/v2.32/docs/reference-typescript#extra_build_args
     */
    extra_build_args?: unknown[];
    /**
     * If specified, install the tool using the lockfile for this named resolve, instead of the version configured in this subsystem
     * https://www.pantsbuild.org/v2.32/docs/reference-typescript#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * If true, don't use TypeScript when running `pants check`
     * https://www.pantsbuild.org/v2.32/docs/reference-typescript#skip
     */
    skip?: boolean;
    /**
     * Version string for the tool in the form package@version (e.g. prettier@3.6.2)
     * https://www.pantsbuild.org/v2.32/docs/reference-typescript#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  'update-build-files'?: {
    /**
     * Do not write changes to disk, only write back what would change
     * https://www.pantsbuild.org/v2.32/docs/reference-update-build-files#check
     */
    check?: boolean;
    /**
     * Automatically fix deprecations, such as target type renames, that are safe because they do not change semantics
     * https://www.pantsbuild.org/v2.32/docs/reference-update-build-files#fix_safe_deprecations
     */
    fix_safe_deprecations?: boolean;
    /**
     * Format BUILD files using Black, Ruff or Yapf
     * https://www.pantsbuild.org/v2.32/docs/reference-update-build-files#fmt
     */
    fmt?: boolean;
    /**
     * Which formatter Pants should use to format BUILD files
     * https://www.pantsbuild.org/v2.32/docs/reference-update-build-files#formatter
     */
  ...
  uv?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-uv#executable_search_paths
     */
    executable_search_paths?: unknown[];
    /**
     * Additional environment variables to pass to `uv` subprocesses
     * https://www.pantsbuild.org/v2.32/docs/reference-uv#extra_env_vars
     */
    extra_env_vars?: unknown[];
    /**
     * Known versions to verify downloads against
     * https://www.pantsbuild.org/v2.32/docs/reference-uv#known_versions
     */
    known_versions?: unknown[];
    /**
     * A dictionary mapping platforms to strings to be used when generating the URL to download the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-uv#url_platform_mapping
     */
    url_platform_mapping?: {
      [k: string]: unknown | undefined;
    };
    /**
     * URL to download the tool, either as a single binary file or a compressed file (e.g. zip file)
     * https://www.pantsbuild.org/v2.32/docs/reference-uv#url_template
     */
    url_template?: string;
    /**
     * What action to take in case the requested version of uv is not supported
     * https://www.pantsbuild.org/v2.32/docs/reference-uv#use_unsupported_version
     */
    use_unsupported_version?: 'error' | 'warning';
    /**
     * Use this version of uv
     * https://www.pantsbuild.org/v2.32/docs/reference-uv#version
     */
    version?: string;
    [k: string]: unknown | undefined;
  };
  ...
  visibility?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-visibility#enforce
     */
    enforce?: boolean;
    /**
     * If true, don't use Visibility Rules when running `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-visibility#skip
     */
    skip?: boolean;
    [k: string]: unknown | undefined;
  };
  ...
  'workunit-logger'?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-workunit-logger#enabled
     */
    enabled?: boolean;
    /**
     * Where to write the log to
     * https://www.pantsbuild.org/v2.32/docs/reference-workunit-logger#logdir
     */
    logdir?: string;
    [k: string]: unknown | undefined;
  };
  ...
  yapf?: {
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-yapf#args
     */
    args?: unknown[];
    /**
     * Path to style file understood by yapf (https://github.com/google/yapf#formatting-style/)
     * https://www.pantsbuild.org/v2.32/docs/reference-yapf#config
     */
    config?: {
      [k: string]: unknown | undefined;
    };
     ...
     * https://www.pantsbuild.org/v2.32/docs/reference-yapf#config_discovery
     */
    config_discovery?: boolean;
    /**
     * The console script for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-yapf#console_script
     */
    console_script?: string;
    /**
     * The entry point for the tool
     * https://www.pantsbuild.org/v2.32/docs/reference-yapf#entry_point
     */
    entry_point?: string;
    /**
     * If specified, install the tool using the lockfile for this named resolve
     * https://www.pantsbuild.org/v2.32/docs/reference-yapf#install_from_resolve
     */
    install_from_resolve?: string;
    /**
     * Python interpreter constraints for this tool
     * https://www.pantsbuild.org/v2.32/docs/reference-yapf#interpreter_constraints
     */
    interpreter_constraints?: unknown[];
    /**
     * If `install_from_resolve` is specified, install these requirements, at the versions provided by the specified resolve's lockfile
     * https://www.pantsbuild.org/v2.32/docs/reference-yapf#requirements
     */
    requirements?: unknown[];
    /**
     * If true, don't use yapf when running `pants fmt` and `pants lint`
     * https://www.pantsbuild.org/v2.32/docs/reference-yapf#skip
     */
    skip?: boolean;
    [k: string]: unknown | undefined;
  };
