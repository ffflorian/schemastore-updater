...
export interface IPTCNinjsNewsInJSONVersion11Approved20140312DocumentRevisionOf20170905SyntaxErrorCorrected {
  ...
  associations?: {
    [k: string]:
      IPTCNinjsNewsInJSONVersion11Approved20140312DocumentRevisionOf20170905SyntaxErrorCorrected | undefined;
  };
  /**
   ...
   */
  [k: string]:
    string | 'text' | 'audio' | 'video' | 'picture' | 'graphic' | 'composite' | 'complete' | 'incomplete' | 'usable' | 'withheld' | 'canceled' | number | {
        /**
         * The name of a person
         */
        name?: string;
