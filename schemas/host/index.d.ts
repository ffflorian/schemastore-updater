  ...
  extensions?: {
    ...
    serviceBus?:
      ...
      | {
          ...
          prefetchCount?: number;
          /**
           * The protocol and transport that is used for communicating with Service Bus.
           */
          ...
          webProxy?: string;
          /**
           * Determines whether or not to automatically complete messages after successful execution of the function and should be used in place of the autoComplete configuration setting.
           */
           ...
           */
          enableCrossEntityTransactions?: boolean;
        };
    /**
     * Configuration settings for 'eventHub' triggers.
     */
...
export interface McpExtension {
  ...
  system?: {
     ...
     */
    webhookAuthorizationLevel?: 'System' | 'Anonymous';
  };
}
