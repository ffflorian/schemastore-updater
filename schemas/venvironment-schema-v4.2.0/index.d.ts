...
export type AdditionalDescriptions = {
  ...
  name: string;
  /**
   * Absolute or relative path to a diagnostic description file (.cdd/.mdx/.pdx/.rdx). Relative path specifications are resolved relative to the configuration file.
   */
  'file-path': (
    | {
        [k: string]: unknown | undefined;
 ...
 */
export type Full4 = Ipv4WithSubnet[];
/**
 ...
 * @maxItems 4094
 */
export type Full6 = VlanSettings[];
/**
 ...
 * @minItems 1
 */
export type Full40 = [PortConfiguration, ...PortConfiguration[]];
/**
 * List of bypass filters.
 *
 * @minItems 1
 */
export type Full41 = [Full42, ...Full42[]];
/**
