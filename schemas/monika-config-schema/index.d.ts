...
/**
 * The request follows redirects as many times as specified here
 */
export type FollowRedirects = number & string;
/**
 ...
 */
export type MonikaConfigurationVersion = string;
...
export interface HttpsGithubComHyperjumptechMonikaMainMonikaConfigSchemaJson {
  ...
  version?: MonikaConfigurationVersion;
}
/**
