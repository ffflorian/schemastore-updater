 ...
 */
export type BlanketHintMostlyUnused = LintLevel | DetailedLint1;
/**
 * Checks for dependency version requirements that do not explicitly specify a full `major.minor.patch` version requirement.
 */
export type ImplicitMinimumVersionReq = LintLevel | DetailedLint1;
/**
 * Checks for unknown lints in the `[lints.cargo]` table.
 */
export type UnknownLints1 = LintLevel | DetailedLint1;
/**
 * Code that does something simple but in a complex way.
 */
export type Complexity1 = LintLevel | DetailedLint1;
/**
 * Code that is outright wrong or useless.
 */
export type Correctness1 = LintLevel | DetailedLint1;
/**
 * New lints that are still under development.
 */
export type Nursery1 = LintLevel | DetailedLint1;
/**
 * Lints which are rather strict or have occasional false positives.
 */
export type Pedantic1 = LintLevel | DetailedLint1;
/**
 * Code that can be written to run faster.
 */
export type Perf1 = LintLevel | DetailedLint1;
/**
 * Lints which prevent the use of Cargo features.
 */
export type Restriction1 = LintLevel | DetailedLint1;
/**
 * Code that should be written in a more idiomatic way.
 */
export type Style1 = LintLevel | DetailedLint1;
/**
 * Code that is most likely wrong or useless.
 */
export type Suspicious1 = LintLevel | DetailedLint1;
/**
