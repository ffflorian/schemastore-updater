 ...
 * Package name.
 */
export type PoetryName = string;
/**
 * Version of the package. It should follow semantic versioning, but it is not enforced.
 */
export type PoetryVersion = string;
/**
 * Short package description.
 */
export type PoetryDescription = string;
/**
...
export interface HttpsJsonSchemastoreOrgPartialPoetryJson {
  /**
  ...
  source?: (
    | {
         ...
         */
        priority?: 'default' | 'primary' | 'secondary' | 'supplemental' | 'explicit';
      }
    | {
        /**
         * The name of the source.
