 ...
 */
export type PythonVersionCompatibility = string;
/**
 ...
 */
export type ProjectMandatoryDependencyRequirements = string[];
/**
...
export interface HttpsJsonSchemastoreOrgPep723Json {
  'requires-python'?: PythonVersionCompatibility;
  dependencies?: ProjectMandatoryDependencyRequirements;
...
export interface CombinedOptions {
   ...
   */
  'add-bounds'?: ('lower' | 'major' | 'minor' | 'exact') | null;
  /**
   ...
   */
  'default-groups'?: ('all' | string[]) | null;
  /**
   ...
   */
  'index-strategy'?: ('first-index' | 'unsafe-first-match' | 'unsafe-best-match') | null;
  /**
   ...
   */
  'keyring-provider'?: ('disabled' | 'subprocess') | null;
  /**
   ...
   */
  'link-mode'?: ('clone' | 'copy' | 'hardlink' | 'symlink') | null;
  /**
   ...
   * are already installed.
   */
  'no-build-isolation-package'?: string[] | null;
  /**
   * Don't build source distributions for a specific package.
   */
  'no-build-package'?: string[] | null;
  /**
   ...
   */
  'python-downloads'?: ('automatic' | 'manual' | 'never') | null;
  /**
   ...
   */
  'python-preference'?: ('only-managed' | 'managed' | 'system' | 'only-system') | null;
  /**
   ...
   */
  'trusted-publishing'?: (('always' | 'never') | 'automatic') | null;
  /**
...
export interface Index {
   ...
   * ```
   */
  authenticate?: ('auto' | 'always' | 'never') & string;
  /**
   ...
   * ```
   */
  'ignore-error-codes'?: number[] | null;
  /**
...
export interface PipOptions {
   ...
   */
  'annotation-style'?: ('line' | 'split') | null;
  /**
   ...
   */
  'no-emit-package'?: string[] | null;
  /**
   * Exclude the specified optional dependencies if `all-extras` is supplied.
   */
  'no-extra'?: string[] | null;
  /**
