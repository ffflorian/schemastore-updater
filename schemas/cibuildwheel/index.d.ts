 ...
 */
export interface HttpsJsonSchemastoreOrgCibuildwheelJson {
  tool?: {
    cibuildwheel?: HttpsJsonSchemastoreOrgPartialCibuildwheelJson;
  };
}
/**
...
export interface HttpsJsonSchemastoreOrgPartialCibuildwheelJson {
  ...
  overrides?: {
    ...
    inherit?: {
       ...
       * How to inherit the parent's value.
       */
      'before-build'?: 'none' | 'prepend' | 'append';
      /**
       * How to inherit the parent's value.
       */
       ...
       * How to inherit the parent's value.
       */
      'before-test'?: 'none' | 'prepend' | 'append';
      /**
       * How to inherit the parent's value.
       */
      'config-settings'?: 'none' | 'prepend' | 'append';
      /**
       * How to inherit the parent's value.
       */
      'container-engine'?: 'none' | 'prepend' | 'append';
      /**
       * How to inherit the parent's value.
       */
      environment?: 'none' | 'prepend' | 'append';
      /**
       * How to inherit the parent's value.
       */
      'environment-pass'?: 'none' | 'prepend' | 'append';
      /**
       * How to inherit the parent's value.
       */
      'repair-wheel-command'?: 'none' | 'prepend' | 'append';
      /**
       * How to inherit the parent's value.
       */
      'test-command'?: 'none' | 'prepend' | 'append';
      /**
       * How to inherit the parent's value.
       */
      'test-extras'?: 'none' | 'prepend' | 'append';
      /**
       * How to inherit the parent's value.
       */
      'test-sources'?: 'none' | 'prepend' | 'append';
      /**
       * How to inherit the parent's value.
       */
      'test-requires'?: 'none' | 'prepend' | 'append';
      /**
       * How to inherit the parent's value.
       */
      'test-environment'?: 'none' | 'prepend' | 'append';
      /**
       * How to inherit the parent's value.
       */
