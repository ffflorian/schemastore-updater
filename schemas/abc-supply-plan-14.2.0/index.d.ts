...
export type ABCAnalyticsItem = TimeSeries | AnalyticsNoteItem | DemandConsumptionAllocationItem;
/**
...
/**
 * Free-text notes for this initial inventory lot. May be empty when no notes are needed.
 */
...
export interface ABCSupplyPlanJSONSchema {
  /**
   * Link to https://json.schemastore.org/abc-supply-plan-14.2.0.json
   */
  $schema: 'https://json.schemastore.org/abc-supply-plan-14.2.0.json';
  planDate: PlanDate;
  planNotes: PlanNotes;
  analytics: {
