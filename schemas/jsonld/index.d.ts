...
export type SchemaForJSONLD = SchemaForJSONLD1 & SchemaForJSONLD2;
export type SchemaForJSONLD1 = Context & Graph & Common;
export type SchemaForJSONLD2 = (Context & Graph & Common) | ((Context & Graph & Common) & unknown[]);
