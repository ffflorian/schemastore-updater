...
export type FormItemsDef = InputsDef | FieldSetDef;
...
/**
 * YAML descriptor for Enonic XP Macros.
 * https://developer.enonic.com/docs/cms/stable/richtext/macros
 */
export interface HttpsJsonSchemastoreOrgEnonicXpMacro800B4Json {
  kind: 'Macro';
