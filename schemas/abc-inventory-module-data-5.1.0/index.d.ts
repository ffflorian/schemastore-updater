...
export type ABCStatus =
  'RELEASED' | 'CONDITIONAL_RELEASED' | 'QUARANTINE' | 'IN_TRANSIT' | 'ON_HOLD' | 'EXPIRED' | 'DAMAGED';
/**
...
export interface ABCInventoryModuleDataJSONSchema {
  /**
   * Link to https://www.schemastore.org/abc-inventory-module-data-5.1.0.json
   */
  $schema: 'https://www.schemastore.org/abc-inventory-module-data-5.1.0.json';
  ABCProducts: {
    /**
     * This interface was referenced by `undefined`'s JSON-Schema definition
     * via the `patternProperty` "^[a-zA-Z0-9_-]+$".
