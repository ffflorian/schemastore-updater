...
/**
 * YAML descriptor for Enonic XP Layouts.
 * https://developer.enonic.com/docs/cms/stable/pages/parts#layouts
 */
export interface HttpsJsonSchemastoreOrgEnonicXpLayout800B5Json {
  kind: 'Layout';
