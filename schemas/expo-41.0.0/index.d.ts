...
export interface JSONSchemaForExpoSDK41AppManifest {
  expo: {
    /**
     ...
     */
    plugins?: (string | [] | [string] | [string, unknown])[];
    /**
    ...
    android?: {
      /**
       * @deprecated Use EAS Build or compile locally instead. If set to true, APK will contain only unimodules that are explicitly added in package.json and their dependencies
       */
