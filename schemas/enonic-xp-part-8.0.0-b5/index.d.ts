...
/**
 * YAML descriptor for Enonic XP Parts.
 * https://developer.enonic.com/docs/cms/stable/pages/parts
 */
export interface HttpsJsonSchemastoreOrgEnonicXpPart800B5Json {
  kind: 'Part';
