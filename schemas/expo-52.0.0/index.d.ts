...
export interface HttpsJsonSchemastoreOrgExpo5200Json {
  expo?: JSONSchemaForExpoSDK52AppManifest;
}
export interface JSONSchemaForExpoSDK52AppManifest {
  /**
  ...
  ios?: {
    ...
    /**
     * The bundle identifier for your iOS standalone app. You make it up, but it needs to be unique on the App Store. See [this StackOverflow question](https://stackoverflow.com/questions/11347470/what-does-bundle-identifier-mean-in-the-ios-project).
     */
