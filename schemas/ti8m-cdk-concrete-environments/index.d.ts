...
/**
 * List of concrete instances (stages) of an environment
 */
export interface ConcreteEnvironmentsLists {
  $schema?: string;
  all?: ConcreteEnvironmentSpec;
  /**
...
/**
 * Common default definitions for all environments which may be overridden by individual environments
 */
export interface ConcreteEnvironmentSpec {
  /**
