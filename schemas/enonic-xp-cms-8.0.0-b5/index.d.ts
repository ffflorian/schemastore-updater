...
/**
 * YAML descriptor for Enonic XP CMS configuration.
 * https://developer.enonic.com/docs/code/stable/schemas
 */
export interface HttpsJsonSchemastoreOrgEnonicXpCms800B5Json {
  kind: 'CMS';
  mixins?: MixinMapping[];
  form?: FormDef;
  config?: GenericValueDef;
}
export interface MixinMapping {
  name: string;
