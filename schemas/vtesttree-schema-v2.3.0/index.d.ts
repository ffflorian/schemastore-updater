...
/**
 * List of lists of parameter values for a test case or test sequence. Each list specifies values for one parameter.
 *
 * @minItems 1
 */
 ...
 */
export interface CAPLTestCaseList {
  /**
   * Function name of the CAPL test case.
   */
 ...
 */
export interface CAPLTestSequenceList {
  /**
   * Function name of the CAPL test sequence.
   */
 ...
 */
export interface NETTestCaseList {
  /**
   * Function name of the .NET test case.
   */
 ...
 */
export interface NETTestSequenceList {
  /**
   * Function name of the .NET test sequence.
   */
 ...
 */
export interface PythonTestCaseList {
  /**
   * Function name of the Python test case.
   */
 ...
 */
export interface PythonTestSequenceList {
  /**
   * Function name of the Python test sequence.
   */
