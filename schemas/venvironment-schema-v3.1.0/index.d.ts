...
/**
 * Describes an application model (.can/.canencr/.cs/.sln/.py/.vmodule/.dll). Also supports local defines.
 */
export interface ApplicationModel {
  ...
  when?: string | boolean;
  /**
   * Absolute or relative path to an application model (.can/.canencr/.cs/.sln/.py/.vmodule/.dll). Relative path specifications are resolved relative to the configuration file.
   */
  'file-path': (
    | {
        [k: string]: unknown | undefined;
