...
/**
 * The treatment arm ID. Null includes all arms.
 */
export type ArmID1 = string | null;
/**
 * The kit item ID. Null includes all items.
 */
...
export interface ABCSupplyPlanJSONSchema {
  /**
   * Link to https://json.schemastore.org/abc-supply-plan-13.0.0.json
   */
